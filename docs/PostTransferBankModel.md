...
| **external_bank_account_guid** | **String** | The customer&#39;s &#39;plaid&#39;, &#39;plaid_processor_token&#39;, or &#39;raw_routing_details&#39; external bank account&#39;s identifier. Required for ACH, EFT, WIRE, and RTP payment rails. For the e-transfer rail, this is the counterparty&#39;s &#39;raw_routing_details&#39; external bank account to request the funds from; omit it for a gateway-only deposit. Required when transfer_type is instant_funding. Optional when transfer_type is funding. | [optional] |
