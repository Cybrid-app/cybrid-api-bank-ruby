...
| ---- | ---- | ----------- | ----- |
| **routing_number_type** | **String** | The type of routing number; one of CPA, ABA, or IFSC. Null for an identifier-only account, such as an Interac e-Transfer email or phone number. |  |
| **routing_number** | **String** | The routing number. Null for an identifier-only account, such as an Interac e-Transfer email or phone number. |  |
...
| **account_designation** | **String** | Account designation for India IFSC and UPI accounts; one of NRE or NRO. Null for non-India accounts. | [optional] |
