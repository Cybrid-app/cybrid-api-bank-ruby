...
module CybridApiBank
  class BankBankModel
    ...
    def hash
      [guid, organization_guid, name, type, supported_trading_symbols, supported_fiat_account_assets, supported_country_codes, features, cors_allowed_origins, created_at, updated_at].hash
    end
