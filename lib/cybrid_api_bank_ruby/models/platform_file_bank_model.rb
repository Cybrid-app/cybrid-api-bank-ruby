...
module CybridApiBank
  class PlatformFileBankModel
    ...
    def valid?
      ...
      return false if !@guid.nil? && @guid.to_s.length < 32
      file_type_validator = EnumAttributeValidator.new('String', ["drivers_license_front", "drivers_license_back", "passport", "visa", "identification_card", "residence_card", "selfie", "selfie_video", "selfie_left", "selfie_right", "utility_bill", "bank_statement", "property_tax", "tax_document", "ein_letter", "incorporation_certificate"])
      return false unless file_type_validator.valid?(@file_type)
      content_type_validator = EnumAttributeValidator.new('String', ["image/jpeg", "image/png", "application/pdf", "video/mp4"])
    ...
    def file_type=(file_type)
      validator = EnumAttributeValidator.new('String', ["drivers_license_front", "drivers_license_back", "passport", "visa", "identification_card", "residence_card", "selfie", "selfie_video", "selfie_left", "selfie_right", "utility_bill", "bank_statement", "property_tax", "tax_document", "ein_letter", "incorporation_certificate"])
    ...
    def content_type=(content_type)
      validator = EnumAttributeValidator.new('String', ["image/jpeg", "image/png", "application/pdf", "video/mp4"])
    ...
    def hash
      [guid, file_type, content_type, completed_at, failed_at, state, failure_code].hash
    end
