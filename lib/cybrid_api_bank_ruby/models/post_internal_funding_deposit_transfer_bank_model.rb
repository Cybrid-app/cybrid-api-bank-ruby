...
module CybridApiBank
  class PostInternalFundingDepositTransferBankModel
    # The environment that the deposit is operating in.
    attr_accessor :environment

    # The identifier of the deposit bank account that corresponds to this transfer.
    attr_accessor :deposit_bank_account_guid

    # The identifier of the parent deposit bank account that corresponds to this transfer.
    ...
    # The payment rail the transfer is being made on.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalFundingDepositTransferBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalFundingDepositTransferBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @deposit_bank_account_guid.to_s.length > 32
        invalid_properties.push('invalid value for "deposit_bank_account_guid", the character length must be smaller than or equal to 32.')
      end

      if @deposit_bank_account_guid.to_s.length < 32
        invalid_properties.push('invalid value for "deposit_bank_account_guid", the character length must be great than or equal to 32.')
      end

      if @parent_deposit_bank_account_guid.nil?
        invalid_properties.push('invalid value for "parent_deposit_bank_account_guid", parent_deposit_bank_account_guid cannot be nil.')
      end

      if @parent_deposit_bank_account_guid.to_s.length > 32
    ...
    def valid?
      ...
      return false if @deposit_bank_account_guid.to_s.length > 32
      return false if @deposit_bank_account_guid.to_s.length < 32
      return false if @parent_deposit_bank_account_guid.nil?
      return false if @parent_deposit_bank_account_guid.to_s.length > 32
      return false if @parent_deposit_bank_account_guid.to_s.length < 32
    ...
    # @param [Object] deposit_bank_account_guid Value to be assigned
    def deposit_bank_account_guid=(deposit_bank_account_guid)
      if deposit_bank_account_guid.nil?
        fail ArgumentError, 'deposit_bank_account_guid cannot be nil'
      end

      if deposit_bank_account_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "deposit_bank_account_guid", the character length must be smaller than or equal to 32.'
      end

      if deposit_bank_account_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "deposit_bank_account_guid", the character length must be great than or equal to 32.'
      end
    ...
    def parent_deposit_bank_account_guid=(parent_deposit_bank_account_guid)
      if parent_deposit_bank_account_guid.nil?
        fail ArgumentError, 'parent_deposit_bank_account_guid cannot be nil'
      end
    ...
    def hash
      [environment, deposit_bank_account_guid, parent_deposit_bank_account_guid, details, amount, payment_rail].hash
    end
