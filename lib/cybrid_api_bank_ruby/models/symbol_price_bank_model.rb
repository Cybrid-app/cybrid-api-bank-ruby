...
module CybridApiBank
  class SymbolPriceBankModel
    ...
    attr_accessor :buy_price_last_updated_at

    # ISO8601 datetime the sale price was generated at.
    attr_accessor :sell_price_last_updated_at
    ...
    def self.attribute_map
      {
        ...
        :'buy_price_last_updated_at' => :'buy_price_last_updated_at',
        :'sell_price_last_updated_at' => :'sell_price_last_updated_at',
    ...
    def self.openapi_types
      {
        ...
        :'buy_price' => :'Integer',
        :'sell_price' => :'Integer',
        :'buy_price_last_updated_at' => :'Time',
        :'sell_price_last_updated_at' => :'Time',
        :'country_code' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::SymbolPriceBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::SymbolPriceBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'buy_price_last_updated_at')
        self.buy_price_last_updated_at = attributes[:'buy_price_last_updated_at']
      end

      if attributes.key?(:'sell_price_last_updated_at')
        self.sell_price_last_updated_at = attributes[:'sell_price_last_updated_at']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          buy_price_last_updated_at == o.buy_price_last_updated_at &&
          sell_price_last_updated_at == o.sell_price_last_updated_at &&
    ...
    def hash
      [symbol, type, buy_price, sell_price, buy_price_last_updated_at, sell_price_last_updated_at, country_code, participants_type, route].hash
    end
