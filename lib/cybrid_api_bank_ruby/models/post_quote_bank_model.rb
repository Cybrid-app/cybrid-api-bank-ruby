...
module CybridApiBank
  ...
  class PostQuoteBankModel
    ...
    attr_accessor :destination_accounts
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'destination_accounts')
        if (value = attributes[:'destination_accounts']).is_a?(Array)
          self.destination_accounts = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if !@network_address.nil? && @network_address.to_s.length > 1024
        invalid_properties.push('invalid value for "network_address", the character length must be smaller than or equal to 1024.')
      end
      ...
      if !@destination_accounts.nil? && @destination_accounts.length > 100
        invalid_properties.push('invalid value for "destination_accounts", number of items must be less than or equal to 100.')
      end

      if !@destination_accounts.nil? && @destination_accounts.length < 1
        invalid_properties.push('invalid value for "destination_accounts", number of items must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      product_type_validator = EnumAttributeValidator.new('String', ["trading", "funding", "book_transfer", "crypto_transfer", "inter_account", "lightning_transfer"])
      ...
      return false if !@network_address.nil? && @network_address.to_s.length > 1024
      ...
      return false if !@destination_accounts.nil? && @destination_accounts.length > 100
      return false if !@destination_accounts.nil? && @destination_accounts.length < 1
    ...
    def product_type=(product_type)
      validator = EnumAttributeValidator.new('String', ["trading", "funding", "book_transfer", "crypto_transfer", "inter_account", "lightning_transfer"])
    ...
    def network_address=(network_address)
      if !network_address.nil? && network_address.to_s.length > 1024
        fail ArgumentError, 'invalid value for "network_address", the character length must be smaller than or equal to 1024.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] destination_accounts Value to be assigned
    def destination_accounts=(destination_accounts)
      if destination_accounts.nil?
        fail ArgumentError, 'destination_accounts cannot be nil'
      end

      if destination_accounts.length > 100
        fail ArgumentError, 'invalid value for "destination_accounts", number of items must be less than or equal to 100.'
      end

      if destination_accounts.length < 1
        fail ArgumentError, 'invalid value for "destination_accounts", number of items must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          symbol == o.symbol &&
          destination_accounts == o.destination_accounts &&
    ...
    def hash
      [product_type, bank_guid, customer_guid, receive_amount, deliver_amount, asset, network_address, fees, side, destination_account_guid, payment_rail, symbol, destination_accounts, reference_trade_guid, source_account_guid].hash
    end
