...
module CybridApiBank
  ...
  class PostQuoteBankModel
    ...
    def hash
      [product_type, bank_guid, customer_guid, receive_amount, deliver_amount, asset, network_address, fees, side, destination_account_guid, symbol, destination_accounts, reference_trade_guid, source_account_guid].hash
    end
