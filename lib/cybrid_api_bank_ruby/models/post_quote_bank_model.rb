...
module CybridApiBank
  ...
  class PostQuoteBankModel
    ...
    def valid?
      product_type_validator = EnumAttributeValidator.new('String', ["trading", "funding", "crypto_transfer", "inter_account", "lightning_transfer", "book_transfer"])
    ...
    def product_type=(product_type)
      validator = EnumAttributeValidator.new('String', ["trading", "funding", "crypto_transfer", "inter_account", "lightning_transfer", "book_transfer"])
