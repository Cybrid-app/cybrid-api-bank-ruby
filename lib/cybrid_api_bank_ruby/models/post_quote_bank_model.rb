...
module CybridApiBank
  ...
  class PostQuoteBankModel
    ...
    def list_invalid_properties
      ...
      if !@destination_accounts.nil? && @destination_accounts.length > 20
        invalid_properties.push('invalid value for "destination_accounts", number of items must be less than or equal to 20.')
      end
    ...
    def valid?
      ...
      return false if !@destination_accounts.nil? && @destination_accounts.length > 20
    ...
    def destination_accounts=(destination_accounts)
      if !destination_accounts.nil? && destination_accounts.length > 20
        fail ArgumentError, 'invalid value for "destination_accounts", number of items must be less than or equal to 20.'
      end
