...
module CybridApiBank
  ...
  class PostQuoteBankModel
    ...
    def valid?
      product_type_validator = EnumAttributeValidator.new('String', ["trading", "trading_exit", "funding", "crypto_transfer", "inter_account", "lightning_transfer", "book_transfer"])
    ...
    def product_type=(product_type)
      validator = EnumAttributeValidator.new('String', ["trading", "trading_exit", "funding", "crypto_transfer", "inter_account", "lightning_transfer", "book_transfer"])
    ...
    def hash
      [product_type, bank_guid, customer_guid, receive_amount, deliver_amount, asset, network_address, fees, side, symbol, destination_accounts, reference_trade_guid, source_account_guid, destination_account_guid].hash
    end
