...
module CybridApiBank
  class PostInternalClaimExchangeSettlementPaymentOrderBankModel
    attr_accessor :system_transaction
    ...
    def self.openapi_types
      {
        :'system_transaction' => :'PostInternalSystemTransactionBankModel'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalClaimExchangeSettlementPaymentOrderBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalClaimExchangeSettlementPaymentOrderBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'system_transaction')
        self.system_transaction = attributes[:'system_transaction']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @system_transaction.nil?
        invalid_properties.push('invalid value for "system_transaction", system_transaction cannot be nil.')
      end
    ...
    def valid?
      return false if @system_transaction.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          system_transaction == o.system_transaction
    end
