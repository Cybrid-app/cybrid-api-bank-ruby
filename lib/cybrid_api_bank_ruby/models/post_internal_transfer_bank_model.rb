...
module CybridApiBank
  class PostInternalTransferBankModel
    ...
    attr_accessor :supports_reconciliation

    # Override indicating if the transfer requires manual confirmation.
    attr_accessor :requires_manual_confirmation
    ...
    def self.openapi_types
      {
        ...
        :'external_id' => :'String',
        :'labels' => :'Array<String>',
        :'associations' => :'Array<InternalTransferAssociationBankModel>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalTransferBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalTransferBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'supports_reconciliation')
        self.supports_reconciliation = attributes[:'supports_reconciliation']
      end

      if attributes.key?(:'requires_manual_confirmation')
        self.requires_manual_confirmation = attributes[:'requires_manual_confirmation']
      end
    ...
    def valid?
      ...
      transfer_type_validator = EnumAttributeValidator.new('String', ["book", "internal_bank_rebalance", "internal_wallet_rebalance", "funding_return", "crypto_return", "loss_recovery", "instant_funding_return"])
    ...
    def transfer_type=(transfer_type)
      validator = EnumAttributeValidator.new('String', ["book", "internal_bank_rebalance", "internal_wallet_rebalance", "funding_return", "crypto_return", "loss_recovery", "instant_funding_return"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          supports_reconciliation == o.supports_reconciliation &&
          requires_manual_confirmation == o.requires_manual_confirmation &&
    ...
    def hash
      [transfer_type, environment, quote_guid, transfer_guid, source_account_guid, destination_account_guid, supports_reconciliation, requires_manual_confirmation, external_id, labels, associations].hash
    end
