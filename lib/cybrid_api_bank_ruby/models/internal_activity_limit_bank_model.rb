...
module CybridApiBank
  class InternalActivityLimitBankModel
    ...
    # The asset of the limit.
    attr_accessor :limit_asset

    # The amount of the limit.
    attr_accessor :limit_amount

    # The interval of the limit.
    attr_accessor :limit_interval
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::InternalActivityLimitBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::InternalActivityLimitBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'limit_asset')
        self.limit_asset = attributes[:'limit_asset']
      end

      if attributes.key?(:'limit_amount')
        self.limit_amount = attributes[:'limit_amount']
      end

      if attributes.key?(:'limit_interval')
        self.limit_interval = attributes[:'limit_interval']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @limit_asset.nil?
        invalid_properties.push('invalid value for "limit_asset", limit_asset cannot be nil.')
      end

      if @limit_amount.nil?
        invalid_properties.push('invalid value for "limit_amount", limit_amount cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @limit_asset.nil?
      return false if @limit_amount.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          limit_asset == o.limit_asset &&
          limit_amount == o.limit_amount &&
          limit_interval == o.limit_interval
    end
    ...
    def hash
      [name, limit_type, limit_asset, limit_amount, limit_interval].hash
    end
