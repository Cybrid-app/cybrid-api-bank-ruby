...
module CybridApiBank
  class PostInternalInternalBankAccountConfigurationBankModel
    # The type of configuration: bank or platform.
    attr_accessor :type
    ...
    # The identifier of the internal bank account to use for transfers.
    attr_accessor :transfer_bank_account_guid

    # The identifier of the internal bank account to use for deposit accounts.
    attr_accessor :deposit_bank_account_guid

    # The identifier of the internal bank account to use for invoice accounts.
    attr_accessor :invoice_bank_account_guid
    ...
    def self.attribute_map
      {
        ...
        :'bank_guid' => :'bank_guid',
        :'transfer_bank_account_guid' => :'transfer_bank_account_guid',
        :'deposit_bank_account_guid' => :'deposit_bank_account_guid',
        :'invoice_bank_account_guid' => :'invoice_bank_account_guid',
        :'asset' => :'asset'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'environment' => :'String',
        :'bank_guid' => :'String',
        :'transfer_bank_account_guid' => :'String',
        :'deposit_bank_account_guid' => :'String',
        :'invoice_bank_account_guid' => :'String',
        :'asset' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalInternalBankAccountConfigurationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalInternalBankAccountConfigurationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transfer_bank_account_guid')
        self.transfer_bank_account_guid = attributes[:'transfer_bank_account_guid']
      end

      if attributes.key?(:'deposit_bank_account_guid')
        self.deposit_bank_account_guid = attributes[:'deposit_bank_account_guid']
      end

      if attributes.key?(:'invoice_bank_account_guid')
        self.invoice_bank_account_guid = attributes[:'invoice_bank_account_guid']
      end
    ...
    def list_invalid_properties
      ...
      if @transfer_bank_account_guid.nil?
        invalid_properties.push('invalid value for "transfer_bank_account_guid", transfer_bank_account_guid cannot be nil.')
      end

      if @deposit_bank_account_guid.nil?
        invalid_properties.push('invalid value for "deposit_bank_account_guid", deposit_bank_account_guid cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@bank_guid.nil? && @bank_guid.to_s.length < 32
      return false if @transfer_bank_account_guid.nil?
      return false if @deposit_bank_account_guid.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transfer_bank_account_guid == o.transfer_bank_account_guid &&
          deposit_bank_account_guid == o.deposit_bank_account_guid &&
          invoice_bank_account_guid == o.invoice_bank_account_guid &&
          asset == o.asset
    end
    ...
    def hash
      [type, environment, bank_guid, transfer_bank_account_guid, deposit_bank_account_guid, invoice_bank_account_guid, asset].hash
    end
