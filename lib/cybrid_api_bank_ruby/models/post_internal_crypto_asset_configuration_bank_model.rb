...
module CybridApiBank
  class PostInternalCryptoAssetConfigurationBankModel
    # The type of crypto asset configuration: bank or platform.
    attr_accessor :type
    ...
    # Flag indicating if the asset is enabled for deposit addresses on the platform.
    attr_accessor :deposits_enabled

    # Flag indicating if the asset is enabled for invoices on the platform.
    attr_accessor :invoices_enabled

    # Flag indicating if the asset is enabled for storage on the platform.
    attr_accessor :storage_enabled

    # The maximum number of deposit addresses allowed for the asset on the platform. Must be omitted or set to nil if deposits_enabled is False.
    attr_accessor :maximum_number_of_addresses
    ...
    def self.attribute_map
      {
        ...
        :'maximum_number_of_addresses' => :'maximum_number_of_addresses',
        :'asset' => :'asset'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'maximum_number_of_addresses' => :'Integer',
        :'asset' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalCryptoAssetConfigurationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalCryptoAssetConfigurationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'deposits_enabled')
        self.deposits_enabled = attributes[:'deposits_enabled']
      end

      if attributes.key?(:'invoices_enabled')
        self.invoices_enabled = attributes[:'invoices_enabled']
      end

      if attributes.key?(:'storage_enabled')
        self.storage_enabled = attributes[:'storage_enabled']
      end

      if attributes.key?(:'maximum_number_of_addresses')
        self.maximum_number_of_addresses = attributes[:'maximum_number_of_addresses']
      end
    ...
    def list_invalid_properties
      ...
      if @deposits_enabled.nil?
        invalid_properties.push('invalid value for "deposits_enabled", deposits_enabled cannot be nil.')
      end

      if !@maximum_number_of_addresses.nil? && @maximum_number_of_addresses < 1
        invalid_properties.push('invalid value for "maximum_number_of_addresses", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@bank_guid.nil? && @bank_guid.to_s.length < 32
      return false if @deposits_enabled.nil?
      return false if !@maximum_number_of_addresses.nil? && @maximum_number_of_addresses < 1
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["platform", "bank"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] maximum_number_of_addresses Value to be assigned
    def maximum_number_of_addresses=(maximum_number_of_addresses)
      if !maximum_number_of_addresses.nil? && maximum_number_of_addresses < 1
        fail ArgumentError, 'invalid value for "maximum_number_of_addresses", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deposits_enabled == o.deposits_enabled &&
          invoices_enabled == o.invoices_enabled &&
          storage_enabled == o.storage_enabled &&
          maximum_number_of_addresses == o.maximum_number_of_addresses &&
          asset == o.asset
    end
    ...
    def hash
      [type, environment, bank_guid, deposits_enabled, invoices_enabled, storage_enabled, maximum_number_of_addresses, asset].hash
    end
