...
module CybridApiBank
  # The customer's address. Required when type is kyc and method is attested, type is kyc and method is attested_business_registration, type is kyc and method is attested_id_and_selfie, type is kyc and method is attested_business_associate, type is kyc and method is attested_id_and_database, or type is kyc and method is attested_database. Optional when type is kyc and method is watchlists or type is bank_account and method is attested_ownership.
  class PostIdentityVerificationAddressBankModel
    ...
    # @param [Object] subdivision Value to be assigned
    def subdivision=(subdivision)
      if !subdivision.nil? && subdivision.to_s.length > 3
        fail ArgumentError, 'invalid value for "subdivision", the character length must be smaller than or equal to 3.'
      end

      if !subdivision.nil? && subdivision.to_s.length < 1
        fail ArgumentError, 'invalid value for "subdivision", the character length must be great than or equal to 1.'
      end
