...
module CybridApiBank
  class StageBankModel
    ...
    def hash
      [guid, type, state, failure_code, identifiers, links, created_at, updated_at, source_account, destination_account, fees, effective_rate, deposit_return_details, withdrawal_return_details].hash
    end
