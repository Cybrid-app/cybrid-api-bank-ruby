...
module CybridApiBank
  class StageBankModel
    ...
    attr_accessor :deposit_return_details

    attr_accessor :withdrawal_return_details

    attr_accessor :payout_return_details
    ...
    def self.attribute_map
      {
        ...
        :'deposit_return_details' => :'deposit_return_details',
        :'withdrawal_return_details' => :'withdrawal_return_details',
        :'payout_return_details' => :'payout_return_details'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'state' => :'String',
        :'failure_code' => :'String',
        :'identifiers' => :'Array<StageIdentifierBankModel>',
        :'links' => :'Array<StageLinkBankModel>',
        :'created_at' => :'Time',
        :'updated_at' => :'Time',
        ...
        :'deposit_return_details' => :'ReturnDetailsBankModel',
        :'withdrawal_return_details' => :'ReturnDetailsBankModel',
        :'payout_return_details' => :'PayoutReturnDetailsBankModel'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::StageBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::StageBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'deposit_return_details')
        self.deposit_return_details = attributes[:'deposit_return_details']
      end

      if attributes.key?(:'withdrawal_return_details')
        self.withdrawal_return_details = attributes[:'withdrawal_return_details']
      end

      if attributes.key?(:'payout_return_details')
        self.payout_return_details = attributes[:'payout_return_details']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deposit_return_details == o.deposit_return_details &&
          withdrawal_return_details == o.withdrawal_return_details &&
          payout_return_details == o.payout_return_details
    end
    ...
    def hash
      [guid, type, state, failure_code, identifiers, links, created_at, updated_at, source_account, destination_account, fees, effective_rate, deposit_return_details, withdrawal_return_details, payout_return_details].hash
    end
