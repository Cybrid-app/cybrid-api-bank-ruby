...
module CybridApiBank
  class CustomerBankModel
    ...
    def hash
      [guid, bank_guid, type, created_at, updated_at, state, name, address, aliases, website, date_of_birth, phone_number, email_address, labels, compliance_decisions, identification_numbers, activity_limits].hash
    end
