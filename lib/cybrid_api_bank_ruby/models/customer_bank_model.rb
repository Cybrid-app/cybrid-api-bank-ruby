...
module CybridApiBank
  class CustomerBankModel
    ...
    def self.openapi_types
      {
        ...
        :'aliases' => :'Array<CustomerAliasesInnerBankModel>',
        :'website' => :'String',
        :'date_of_birth' => :'Date',
        :'phone_number' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'activity_limits')
        if (value = attributes[:'activity_limits']).is_a?(Array)
          self.activity_limits = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          activity_limits == o.activity_limits
    end
    ...
    def hash
      [guid, bank_guid, type, created_at, updated_at, state, name, address, aliases, website, date_of_birth, phone_number, email_address, citizenship, labels, compliance_decisions, identification_numbers, activity_limits].hash
    end
