...
module CybridApiBank
  class IdentityVerificationWithDetailsBankModel
    ...
    attr_accessor :compliance_checks
    ...
    attr_accessor :business_associates
    ...
    def self.openapi_types
      {
        ...
        :'business_associates' => :'Array<IdentityVerificationBusinessAssociateBankModel>',
        :'pii' => :'IdentityVerificationWithDetailsPiiBankModel',
        :'documents' => :'Array<IdentityVerificationDocumentBankModel>',
        :'supporting_files' => :'Array<IdentityVerificationDocumentBankModel>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::IdentityVerificationWithDetailsBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::IdentityVerificationWithDetailsBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'compliance_checks')
        if (value = attributes[:'compliance_checks']).is_a?(Array)
          self.compliance_checks = value
        end
      end
      ...
      if attributes.key?(:'business_associates')
        if (value = attributes[:'business_associates']).is_a?(Array)
          self.business_associates = value
        end
      end
      ...
      if attributes.key?(:'supporting_files')
        if (value = attributes[:'supporting_files']).is_a?(Array)
          self.supporting_files = value
        end
      end
    ...
    def hash
      [guid, type, method, created_at, updated_at, customer_guid, counterparty_guid, external_bank_account_guid, state, outcome, failure_codes, compliance_checks, compliance_decisions, persona_inquiry_id, persona_state, business_associates, pii, documents, supporting_files, options].hash
    end
