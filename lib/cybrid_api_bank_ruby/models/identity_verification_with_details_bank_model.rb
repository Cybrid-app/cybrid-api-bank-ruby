...
module CybridApiBank
  class IdentityVerificationWithDetailsBankModel
    ...
    def hash
      [guid, type, method, created_at, updated_at, customer_guid, counterparty_guid, external_bank_account_guid, state, outcome, failure_codes, compliance_checks, compliance_decisions, persona_inquiry_id, persona_state, business_associates, pii, documents, supporting_files].hash
    end
