...
module CybridApiBank
  class TransferBankModel
    ...
    def hash
      [guid, transfer_type, bank_guid, customer_guid, quote_guid, external_bank_account_guid, asset, side, state, failure_code, return_code, amount, estimated_amount, fee, estimated_network_fee, network_fee, network_fee_asset, network_fee_liability_amount, network_fee_liability_amount_asset, txn_hash, identifiers, reference_transfer_guid, source_account, source_participants, destination_account, destination_participants, deposit_address_guid, created_at, updated_at, hold_details, transfer_details, payment_rail, external_id, labels, entries].hash
    end
