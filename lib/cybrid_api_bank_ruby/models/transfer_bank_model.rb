...
module CybridApiBank
  class TransferBankModel
    ...
    def self.openapi_types
      {
        ...
        :'created_at' => :'Time',
        :'updated_at' => :'Time',
        :'hold_details' => :'TransferHoldDetailsBankModel',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'fee_details')
        if (value = attributes[:'fee_details']).is_a?(Array)
          self.fee_details = value
        end
      end
      ...
      if attributes.key?(:'hold_details')
        self.hold_details = attributes[:'hold_details']
      end
    ...
    def hash
      [guid, transfer_type, bank_guid, customer_guid, quote_guid, external_bank_account_guid, asset, side, state, failure_code, return_code, amount, estimated_amount, fee, fee_details, estimated_network_fee, network_fee, network_fee_asset, network_fee_liability_amount, network_fee_liability_amount_asset, txn_hash, identifiers, reference_transfer_guid, source_account, source_participants, destination_account, destination_participants, deposit_address_guid, created_at, updated_at, hold_details, transfer_details, payment_rail, external_id, labels, entries].hash
    end
