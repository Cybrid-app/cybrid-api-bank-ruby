...
module CybridApiBank
  class TravelRuleInfoPartyBankModel
    # The type of entity; one of bank, customer, or counterparty.
    attr_accessor :type

    # The unique identifier for the participant.
    attr_accessor :participant_guid
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::TravelRuleInfoPartyBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::TravelRuleInfoPartyBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'participant_guid')
        self.participant_guid = attributes[:'participant_guid']
      else
        self.participant_guid = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @participant_guid.nil?
        invalid_properties.push('invalid value for "participant_guid", participant_guid cannot be nil.')
      end

      if @participant_guid.to_s.length > 32
        invalid_properties.push('invalid value for "participant_guid", the character length must be smaller than or equal to 32.')
      end

      if @participant_guid.to_s.length < 32
        invalid_properties.push('invalid value for "participant_guid", the character length must be great than or equal to 32.')
      end
    ...
    def valid?
      ...
      return false if @participant_guid.nil?
      return false if @participant_guid.to_s.length > 32
      return false if @participant_guid.to_s.length < 32
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] participant_guid Value to be assigned
    def participant_guid=(participant_guid)
      if participant_guid.nil?
        fail ArgumentError, 'participant_guid cannot be nil'
      end

      if participant_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "participant_guid", the character length must be smaller than or equal to 32.'
      end

      if participant_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "participant_guid", the character length must be great than or equal to 32.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          participant_guid == o.participant_guid
    end
