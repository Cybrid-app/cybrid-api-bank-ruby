...
module CybridApiBank
  class ExternalBankAccountPiiInnerRoutingDetailsInnerBankModel
    ...
    attr_accessor :account_designation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::ExternalBankAccountPiiInnerRoutingDetailsInnerBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::ExternalBankAccountPiiInnerRoutingDetailsInnerBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_designation')
        self.account_designation = attributes[:'account_designation']
      end
    end
    ...
    def valid?
      ...
      payment_rail_validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "FEDNOW", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "UPI", "SBP", "BEFTN", "NGBANK", "LBTR", "SEPA", "EASY_PAISA", "FINJA", "JAZZ_CASH", "NAYA_PAY", "SADA_PAY", "KEBANK", "HKBANK", "MPESA", "CNBANK", "FPS", "ALIPAY", "UNSPECIFIED"])
      return false unless payment_rail_validator.valid?(@payment_rail)
      account_designation_validator = EnumAttributeValidator.new('String', ["NRE", "NRO"])
      return false unless account_designation_validator.valid?(@account_designation)
      true
    end
    ...
    def payment_rail=(payment_rail)
      validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "FEDNOW", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "UPI", "SBP", "BEFTN", "NGBANK", "LBTR", "SEPA", "EASY_PAISA", "FINJA", "JAZZ_CASH", "NAYA_PAY", "SADA_PAY", "KEBANK", "HKBANK", "MPESA", "CNBANK", "FPS", "ALIPAY", "UNSPECIFIED"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] account_designation Object to be assigned
    def account_designation=(account_designation)
      validator = EnumAttributeValidator.new('String', ["NRE", "NRO"])
      unless validator.valid?(account_designation)
        fail ArgumentError, "invalid value for \"account_designation\", must be one of #{validator.allowable_values}."
      end
      @account_designation = account_designation
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account_designation == o.account_designation
    end
    ...
    def hash
      [routing_number_type, routing_number, payment_rail, account_designation].hash
    end
