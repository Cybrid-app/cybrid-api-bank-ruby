...
module CybridApiBank
  class ExternalBankAccountPiiInnerRoutingDetailsInnerBankModel
    ...
    # The payment rail this routing entry is configured for; one of EFT, ACH, RTP, WIRE, SPEI, PIX, COELSA, PSE, ETRANSFER, IFSC, SBP, BEFTN, NGBANK, LBTR, SEPA, EASY_PAISA, FINJA, JAZZ_CASH, NAYA_PAY, SADA_PAY, KEBANK, HKBANK, MPESA, CNBANK, or UNSPECIFIED. Null for accounts that did not specify a rail.
    ...
    def valid?
      ...
      payment_rail_validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "SBP", "BEFTN", "NGBANK", "LBTR", "SEPA", "EASY_PAISA", "FINJA", "JAZZ_CASH", "NAYA_PAY", "SADA_PAY", "KEBANK", "HKBANK", "MPESA", "CNBANK", "UNSPECIFIED"])
    ...
    def payment_rail=(payment_rail)
      validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "SBP", "BEFTN", "NGBANK", "LBTR", "SEPA", "EASY_PAISA", "FINJA", "JAZZ_CASH", "NAYA_PAY", "SADA_PAY", "KEBANK", "HKBANK", "MPESA", "CNBANK", "UNSPECIFIED"])
    ...
    def hash
      [routing_number_type, routing_number, payment_rail].hash
    end
