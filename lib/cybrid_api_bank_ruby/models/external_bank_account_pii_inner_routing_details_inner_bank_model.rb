...
module CybridApiBank
  class ExternalBankAccountPiiInnerRoutingDetailsInnerBankModel
    ...
    def valid?
      ...
      payment_rail_validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "FEDNOW", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "SBP", "BEFTN", "NGBANK", "LBTR", "SEPA", "EASY_PAISA", "FINJA", "JAZZ_CASH", "NAYA_PAY", "SADA_PAY", "KEBANK", "HKBANK", "MPESA", "CNBANK", "FPS", "ALIPAY", "UNSPECIFIED"])
    ...
    def payment_rail=(payment_rail)
      validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "FEDNOW", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "SBP", "BEFTN", "NGBANK", "LBTR", "SEPA", "EASY_PAISA", "FINJA", "JAZZ_CASH", "NAYA_PAY", "SADA_PAY", "KEBANK", "HKBANK", "MPESA", "CNBANK", "FPS", "ALIPAY", "UNSPECIFIED"])
