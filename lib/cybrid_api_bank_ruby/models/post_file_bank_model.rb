...
module CybridApiBank
  ...
  class PostFileBankModel
    ...
    def self.openapi_types
      {
        ...
        :'content_type' => :'String',
        :'data' => :'String',
        :'metadata' => :'PostFileMetadataBankModel'
      }
    end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["drivers_license_front", "drivers_license_back", "drivers_license", "passport", "passport_card", "visa", "identification_card", "residence_card", "work_permit", "indigenous_id_document", "selfie", "selfie_video", "selfie_left", "selfie_right", "utility_bill", "proof_of_address", "bank_statement", "property_tax", "tax_document", "ein_letter", "incorporation_certificate", "persona_inquiry_report", "persona_inquiry_export"])
    ...
    def hash
      [type, customer_guid, filename, content_type, data, metadata].hash
    end
