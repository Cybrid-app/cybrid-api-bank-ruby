...
module CybridApiBank
  ...
  class PostFileBankModel
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["drivers_license_front", "drivers_license_back", "passport", "visa", "identification_card", "residence_card", "selfie", "selfie_video", "selfie_left", "selfie_right", "utility_bill", "bank_statement", "property_tax", "tax_document", "ein_letter", "incorporation_certificate", "persona_inquiry_report", "persona_inquiry_export"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["drivers_license_front", "drivers_license_back", "passport", "visa", "identification_card", "residence_card", "selfie", "selfie_video", "selfie_left", "selfie_right", "utility_bill", "bank_statement", "property_tax", "tax_document", "ein_letter", "incorporation_certificate", "persona_inquiry_report", "persona_inquiry_export"])
    ...
    def content_type=(content_type)
      validator = EnumAttributeValidator.new('String', ["image/jpeg", "image/png", "application/pdf", "application/json", "video/mp4"])
    ...
    def data=(data)
      if !data.nil? && data.to_s.length > 10485760
        fail ArgumentError, 'invalid value for "data", the character length must be smaller than or equal to 10485760.'
      end
