...
module CybridApiBank
  ...
  class PostFileBankModel
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["drivers_license_front", "drivers_license_back", "passport", "passport_card", "visa", "identification_card", "residence_card", "work_permit", "selfie", "selfie_video", "selfie_left", "selfie_right", "utility_bill", "proof_of_address", "bank_statement", "property_tax", "tax_document", "ein_letter", "incorporation_certificate", "persona_inquiry_report", "persona_inquiry_export"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["drivers_license_front", "drivers_license_back", "passport", "passport_card", "visa", "identification_card", "residence_card", "work_permit", "selfie", "selfie_video", "selfie_left", "selfie_right", "utility_bill", "proof_of_address", "bank_statement", "property_tax", "tax_document", "ein_letter", "incorporation_certificate", "persona_inquiry_report", "persona_inquiry_export"])
