...
module CybridApiBank
  ...
  class PostFileBankModel
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["drivers_license_front", "drivers_license_back", "passport", "identification_card", "residence_card", "selfie", "selfie_left", "selfie_right", "utility_bill", "bank_statement", "property_tax", "tax_document", "ein_letter", "incorporation_certificate"])
