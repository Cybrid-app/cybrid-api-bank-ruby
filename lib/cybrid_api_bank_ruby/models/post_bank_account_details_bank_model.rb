...
module CybridApiBank
  ...
  class PostBankAccountDetailsBankModel
    ...
    attr_accessor :account_identifier_type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostBankAccountDetailsBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostBankAccountDetailsBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'bank_code_type')
        self.bank_code_type = attributes[:'bank_code_type']
      end
      ...
      if attributes.key?(:'account_identifier_type')
        self.account_identifier_type = attributes[:'account_identifier_type']
      end
    ...
    def list_invalid_properties
      ...
      if @bank_code_type.nil?
        invalid_properties.push('invalid value for "bank_code_type", bank_code_type cannot be nil.')
      end
    ...
    def valid?
      return false if @bank_code_type.nil?
      bank_code_type_validator = EnumAttributeValidator.new('String', ["CPA", "ABA", "CLABE", "PIX", "CBU_CVU", "PSE", "IFSC", "IBAN", "SBP", "BEFTN", "SWIFT_BIC", "CBN"])
      return false unless bank_code_type_validator.valid?(@bank_code_type)
      return false if @account_identifier.nil?
      account_identifier_type_validator = EnumAttributeValidator.new('String', ["CLABE", "PHONE_NUMBER", "EMAIL", "DEBIT_CARD", "CBU", "CVU", "RANDOM", "CPF", "CNPJ"])
      return false unless account_identifier_type_validator.valid?(@account_identifier_type)
      return false if @payment_rail.nil?
      payment_rail_validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "SBP", "BEFTN", "NGBANK", "UNSPECIFIED"])
    ...
    # @param [Object] bank_code_type Object to be assigned
    def bank_code_type=(bank_code_type)
      validator = EnumAttributeValidator.new('String', ["CPA", "ABA", "CLABE", "PIX", "CBU_CVU", "PSE", "IFSC", "IBAN", "SBP", "BEFTN", "SWIFT_BIC", "CBN"])
      unless validator.valid?(bank_code_type)
        fail ArgumentError, "invalid value for \"bank_code_type\", must be one of #{validator.allowable_values}."
      end
      @bank_code_type = bank_code_type
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] account_identifier_type Object to be assigned
    def account_identifier_type=(account_identifier_type)
      validator = EnumAttributeValidator.new('String', ["CLABE", "PHONE_NUMBER", "EMAIL", "DEBIT_CARD", "CBU", "CVU", "RANDOM", "CPF", "CNPJ"])
      unless validator.valid?(account_identifier_type)
        fail ArgumentError, "invalid value for \"account_identifier_type\", must be one of #{validator.allowable_values}."
      end
      @account_identifier_type = account_identifier_type
    end
    ...
    def payment_rail=(payment_rail)
      validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "SBP", "BEFTN", "NGBANK", "UNSPECIFIED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          bank_code_type == o.bank_code_type &&
          bank_code == o.bank_code &&
          account_identifier == o.account_identifier &&
          account_identifier_type == o.account_identifier_type &&
    ...
    def hash
      [bank_code_type, bank_code, account_identifier, account_identifier_type, payment_rail, account_type].hash
    end
