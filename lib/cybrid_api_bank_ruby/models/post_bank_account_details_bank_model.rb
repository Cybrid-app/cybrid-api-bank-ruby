...
module CybridApiBank
  ...
  class PostBankAccountDetailsBankModel
    ...
    def valid?
      ...
      bank_code_type_validator = EnumAttributeValidator.new('String', ["CPA", "ABA", "CLABE", "PIX", "CBU_CVU", "PSE", "IFSC"])
      ...
      payment_rail_validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "UNSPECIFIED"])
    ...
    def bank_code_type=(bank_code_type)
      validator = EnumAttributeValidator.new('String', ["CPA", "ABA", "CLABE", "PIX", "CBU_CVU", "PSE", "IFSC"])
    ...
    def payment_rail=(payment_rail)
      validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "UNSPECIFIED"])
