...
module CybridApiBank
  ...
  class PostBankAccountDetailsBankModel
    ...
    def valid?
      ...
      account_identifier_type_validator = EnumAttributeValidator.new('String', ["CLABE", "PHONE_NUMBER", "EMAIL", "DEBIT_CARD", "CBU", "CVU", "RANDOM", "CPF", "CNPJ", "VPA"])
      ...
      bank_code_type_validator = EnumAttributeValidator.new('String', ["CPA", "ABA", "CLABE", "PIX", "CBU_CVU", "PSE", "IFSC", "IBAN", "SBP", "BEFTN", "SWIFT_BIC", "CBN", "SORT_CODE"])
    ...
    def account_identifier_type=(account_identifier_type)
      validator = EnumAttributeValidator.new('String', ["CLABE", "PHONE_NUMBER", "EMAIL", "DEBIT_CARD", "CBU", "CVU", "RANDOM", "CPF", "CNPJ", "VPA"])
    ...
    def bank_code_type=(bank_code_type)
      validator = EnumAttributeValidator.new('String', ["CPA", "ABA", "CLABE", "PIX", "CBU_CVU", "PSE", "IFSC", "IBAN", "SBP", "BEFTN", "SWIFT_BIC", "CBN", "SORT_CODE"])
    ...
    def hash
      [bank_code, account_identifier, account_identifier_type, payment_rail, bank_code_type, account_type, account_designation].hash
    end
