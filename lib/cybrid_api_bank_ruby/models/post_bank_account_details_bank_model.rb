...
module CybridApiBank
  ...
  class PostBankAccountDetailsBankModel
    ...
    def valid?
      ...
      payment_rail_validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "SBP", "BEFTN", "NGBANK", "LBTR", "EASY_PAISA", "FINJA", "JAZZ_CASH", "NAYA_PAY", "SADA_PAY", "UNSPECIFIED"])
    ...
    def payment_rail=(payment_rail)
      validator = EnumAttributeValidator.new('String', ["EFT", "ACH", "RTP", "WIRE", "SPEI", "PIX", "COELSA", "PSE", "ETRANSFER", "IFSC", "SBP", "BEFTN", "NGBANK", "LBTR", "EASY_PAISA", "FINJA", "JAZZ_CASH", "NAYA_PAY", "SADA_PAY", "UNSPECIFIED"])
