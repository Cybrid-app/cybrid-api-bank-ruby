...
module CybridApiBank
  ...
  class IdentityVerificationWithDetailsPiiBankModel
    ...
    def hash
      [name, aliases, address, date_of_birth, phone_number, email_address, occupation, citizenship, website, nature_of_business, registered_address, business_industry, business_funds_source, business_funds_destination, identification_numbers].hash
    end
