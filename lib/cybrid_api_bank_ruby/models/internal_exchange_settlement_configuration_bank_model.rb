...
module CybridApiBank
  ...
  class InternalExchangeSettlementConfigurationBankModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'omnibus_account_type')
        self.omnibus_account_type = attributes[:'omnibus_account_type']
      end
      ...
      if attributes.key?(:'exchange_account_type')
        self.exchange_account_type = attributes[:'exchange_account_type']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          omnibus_account_type == o.omnibus_account_type &&
          exchange_account_guid == o.exchange_account_guid &&
          exchange_account_type == o.exchange_account_type
    end
    ...
    def hash
      [guid, created_at, updated_at, asset, exchange_guid, omnibus_account_guid, omnibus_account_type, exchange_account_guid, exchange_account_type].hash
    end
