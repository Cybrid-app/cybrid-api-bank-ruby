...
module CybridApiBank
  class AccountBankModel
    ...
    attr_accessor :minimum_balance_funding_pull
    ...
    def self.attribute_map
      {
        ...
        :'minimum_balance_funding_pull' => :'minimum_balance_funding_pull',
    ...
    def self.openapi_types
      {
        ...
        :'minimum_balance_funding_pull' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'minimum_balance_funding_pull')
        self.minimum_balance_funding_pull = attributes[:'minimum_balance_funding_pull']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          minimum_balance_funding_pull == o.minimum_balance_funding_pull &&
    ...
    def hash
      [type, guid, created_at, updated_at, asset, name, bank_guid, customer_guid, platform_balance, minimum_balance_funding_pull, platform_available, state, labels].hash
    end
