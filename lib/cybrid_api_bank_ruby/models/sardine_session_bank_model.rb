...
module CybridApiBank
  class SardineSessionBankModel
    ...
    def self.attribute_map
      {
        :'guid' => :'guid',
        :'sardine_session_key' => :'sardine_session_key',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::SardineSessionBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::SardineSessionBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sardine_session_key')
        self.sardine_session_key = attributes[:'sardine_session_key']
      else
        self.sardine_session_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @sardine_session_key.nil?
        invalid_properties.push('invalid value for "sardine_session_key", sardine_session_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @sardine_session_key.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          guid == o.guid &&
          sardine_session_key == o.sardine_session_key &&
    ...
    def hash
      [guid, sardine_session_key, customer_guid, expires_at].hash
    end
