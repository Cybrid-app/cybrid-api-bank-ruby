...
module CybridApiBank
  ...
  class PostIdentityVerificationBankModel
    ...
    attr_accessor :business_funds_source
    ...
    attr_accessor :business_funds_destination
    ...
    attr_accessor :business_incorporation_date
    ...
    attr_accessor :biometrics_verified
    ...
    def self.attribute_map
      {
        ...
        :'business_funds_source' => :'business_funds_source',
        :'business_funds_destination' => :'business_funds_destination',
        :'business_type' => :'business_type',
        :'business_incorporation_date' => :'business_incorporation_date',
        :'occupation' => :'occupation',
        :'citizenship' => :'citizenship',
        :'biometrics_verified' => :'biometrics_verified',
    ...
    def self.openapi_types
      {
        ...
        :'registered_address' => :'PostIdentityVerificationRegisteredAddressBankModel',
        :'business_industry' => :'String',
        :'business_funds_source' => :'String',
        :'business_funds_destination' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'business_funds_source')
        self.business_funds_source = attributes[:'business_funds_source']
      end

      if attributes.key?(:'business_funds_destination')
        self.business_funds_destination = attributes[:'business_funds_destination']
      end
      ...
      if attributes.key?(:'business_incorporation_date')
        self.business_incorporation_date = attributes[:'business_incorporation_date']
      end
      ...
      if attributes.key?(:'biometrics_verified')
        self.biometrics_verified = attributes[:'biometrics_verified']
      end
    ...
    def list_invalid_properties
      ...
      if !@nature_of_business.nil? && @nature_of_business.to_s.length > 256
        invalid_properties.push('invalid value for "nature_of_business", the character length must be smaller than or equal to 256.')
      end
    ...
    def valid?
      ...
      return false if !@nature_of_business.nil? && @nature_of_business.to_s.length > 256
      ...
      business_industry_validator = EnumAttributeValidator.new('String', ["crypto_digital_assets_blockchain", "education", "gaming", "healthcare_hospitality", "lending_investments", "logistics_manufacturing_transportation", "money_services_payments_remittance", "consulting_legal_accounting", "real_estate_property_management", "retail_ecommerce", "social_media_content_creator_influencer", "technology_software_saas", "wholesale_distribution", "other"])
      return false unless business_industry_validator.valid?(@business_industry)
      business_type_validator = EnumAttributeValidator.new('String', ["entity", "sole_proprietor"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["watchlists", "attested", "document_submission", "enhanced_due_diligence", "id_and_selfie", "tax_id_and_selfie", "business_registration", "attested_id_and_selfie", "attested_business_registration", "attested_business_associate", "attested_id_and_database", "attested_database", "database", "attested_ownership", "account_ownership"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] nature_of_business Value to be assigned
    def nature_of_business=(nature_of_business)
      if !nature_of_business.nil? && nature_of_business.to_s.length > 256
        fail ArgumentError, 'invalid value for "nature_of_business", the character length must be smaller than or equal to 256.'
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] business_industry Object to be assigned
    def business_industry=(business_industry)
      validator = EnumAttributeValidator.new('String', ["crypto_digital_assets_blockchain", "education", "gaming", "healthcare_hospitality", "lending_investments", "logistics_manufacturing_transportation", "money_services_payments_remittance", "consulting_legal_accounting", "real_estate_property_management", "retail_ecommerce", "social_media_content_creator_influencer", "technology_software_saas", "wholesale_distribution", "other"])
      unless validator.valid?(business_industry)
        fail ArgumentError, "invalid value for \"business_industry\", must be one of #{validator.allowable_values}."
      end
      @business_industry = business_industry
    end
    ...
    def business_type=(business_type)
      validator = EnumAttributeValidator.new('String', ["entity", "sole_proprietor"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          business_funds_source == o.business_funds_source &&
          business_funds_destination == o.business_funds_destination &&
          business_type == o.business_type &&
          business_incorporation_date == o.business_incorporation_date &&
          occupation == o.occupation &&
          citizenship == o.citizenship &&
          biometrics_verified == o.biometrics_verified &&
    ...
    def hash
      [type, customer_guid, expected_behaviours, method, counterparty_guid, country_code, require_tax_id, name, address, date_of_birth, identification_numbers, aliases, phone_number, email_address, website, nature_of_business, director_customer_guids, ultimate_beneficial_owners, supporting_file_guids, registered_address, business_industry, business_funds_source, business_funds_destination, business_type, business_incorporation_date, occupation, citizenship, biometrics_verified, external_bank_account_guid].hash
    end
