...
module CybridApiBank
  ...
  class PostWorkflowBankModel
    ...
    def redirect_uri=(redirect_uri)
      ...
      if redirect_uri.to_s.length > 128
    ...
    def android_package_name=(android_package_name)
      if android_package_name.nil?
        fail ArgumentError, 'android_package_name cannot be nil'
      end

      if android_package_name.to_s.length > 128
