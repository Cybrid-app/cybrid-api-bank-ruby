...
module CybridApiBank
  class IdentityVerificationBankModel
    ...
    # The identity verification method; one of attested, document_submission, enhanced_due_diligence, id_and_selfie, tax_id_and_selfie, business_registration, attested_id_and_selfie, attested_business_registration, attested_business_associate, watchlists, attested_ownership, or account_ownership.
    ...
    attr_accessor :compliance_decisions
    ...
    def self.openapi_types
      {
        ...
        :'options' => :'IdentityVerificationOptionsBankModel'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::IdentityVerificationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::IdentityVerificationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'compliance_decisions')
        if (value = attributes[:'compliance_decisions']).is_a?(Array)
          self.compliance_decisions = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          compliance_decisions == o.compliance_decisions &&
          options == o.options
    end
    ...
    def hash
      [guid, type, method, created_at, updated_at, customer_guid, counterparty_guid, external_bank_account_guid, state, outcome, failure_codes, compliance_decisions, options].hash
    end
