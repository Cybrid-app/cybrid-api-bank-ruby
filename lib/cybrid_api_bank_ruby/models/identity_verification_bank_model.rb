...
module CybridApiBank
  class IdentityVerificationBankModel
    ...
    def hash
      [guid, type, method, created_at, updated_at, customer_guid, counterparty_guid, external_bank_account_guid, state, outcome, failure_codes, compliance_decisions].hash
    end
