...
module CybridApiBank
  class PostInternalExpectedPaymentBankModel
    ...
    def hash
      [payment_kind, nonce, payment_amount, internal_account_guid, internal_account_type, exchange_settlement_guid, exchange_settlement_obligation_guid, environment, credit_account_guid, settlement_account_guid].hash
    end
