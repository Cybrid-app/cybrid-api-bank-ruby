...
module CybridApiBank
  class AccountAssociationBankModel
    ...
    attr_accessor :intermediate_requested
    ...
    def self.attribute_map
      {
        ...
        :'intermediate_requested' => :'intermediate_requested'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'payment_rail' => :'String',
        :'intermediate_requested' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::AccountAssociationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::AccountAssociationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'intermediate_requested')
        self.intermediate_requested = attributes[:'intermediate_requested']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          intermediate_requested == o.intermediate_requested
    end
    ...
    def hash
      [guid, type, organization_guid, bank_guid, customer_guid, counterparty_guid, asset, requested_amount, quoted_amount, executed_amount, payment_rail, intermediate_requested].hash
    end
