...
module CybridApiBank
  class InternalCybridGasAccountConfigurationBankModel
    ...
    # The internal wallet identifier that the configuration is associated with.
    attr_accessor :internal_wallet_guid

    # The network fee internal wallet identifier that the configuration is associated with.
    attr_accessor :network_fee_internal_wallet_guid

    # The cybrid account identifier that the configuration is associated with.
    attr_accessor :cybrid_account_guid

    # The asset code.
    attr_accessor :asset

    # The network fee asset code.
    ...
    def self.attribute_map
      {
        ...
        :'network_fee_internal_wallet_guid' => :'network_fee_internal_wallet_guid',
        :'cybrid_account_guid' => :'cybrid_account_guid',
        :'asset' => :'asset',
    ...
    def self.openapi_types
      {
        :'guid' => :'String',
        :'environment' => :'String',
        :'internal_wallet_guid' => :'String',
        :'network_fee_internal_wallet_guid' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::InternalCybridGasAccountConfigurationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::InternalCybridGasAccountConfigurationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'internal_wallet_guid')
        self.internal_wallet_guid = attributes[:'internal_wallet_guid']
      end

      if attributes.key?(:'network_fee_internal_wallet_guid')
        self.network_fee_internal_wallet_guid = attributes[:'network_fee_internal_wallet_guid']
      end

      if attributes.key?(:'cybrid_account_guid')
        self.cybrid_account_guid = attributes[:'cybrid_account_guid']
      end
    ...
    def list_invalid_properties
      ...
      if !@internal_wallet_guid.nil? && @internal_wallet_guid.to_s.length > 32
        invalid_properties.push('invalid value for "internal_wallet_guid", the character length must be smaller than or equal to 32.')
      end

      if !@internal_wallet_guid.nil? && @internal_wallet_guid.to_s.length < 32
        invalid_properties.push('invalid value for "internal_wallet_guid", the character length must be great than or equal to 32.')
      end

      if !@network_fee_internal_wallet_guid.nil? && @network_fee_internal_wallet_guid.to_s.length > 32
        invalid_properties.push('invalid value for "network_fee_internal_wallet_guid", the character length must be smaller than or equal to 32.')
      end

      if !@network_fee_internal_wallet_guid.nil? && @network_fee_internal_wallet_guid.to_s.length < 32
        invalid_properties.push('invalid value for "network_fee_internal_wallet_guid", the character length must be great than or equal to 32.')
      end

      if !@cybrid_account_guid.nil? && @cybrid_account_guid.to_s.length > 32
        invalid_properties.push('invalid value for "cybrid_account_guid", the character length must be smaller than or equal to 32.')
      end

      if !@cybrid_account_guid.nil? && @cybrid_account_guid.to_s.length < 32
        invalid_properties.push('invalid value for "cybrid_account_guid", the character length must be great than or equal to 32.')
      end
    ...
    def valid?
      ...
      return false if !@internal_wallet_guid.nil? && @internal_wallet_guid.to_s.length > 32
      return false if !@internal_wallet_guid.nil? && @internal_wallet_guid.to_s.length < 32
      return false if !@network_fee_internal_wallet_guid.nil? && @network_fee_internal_wallet_guid.to_s.length > 32
      return false if !@network_fee_internal_wallet_guid.nil? && @network_fee_internal_wallet_guid.to_s.length < 32
      return false if !@cybrid_account_guid.nil? && @cybrid_account_guid.to_s.length > 32
      return false if !@cybrid_account_guid.nil? && @cybrid_account_guid.to_s.length < 32
    ...
    # Custom attribute writer method with validation
    # @param [Object] internal_wallet_guid Value to be assigned
    def internal_wallet_guid=(internal_wallet_guid)
      if !internal_wallet_guid.nil? && internal_wallet_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "internal_wallet_guid", the character length must be smaller than or equal to 32.'
      end

      if !internal_wallet_guid.nil? && internal_wallet_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "internal_wallet_guid", the character length must be great than or equal to 32.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] network_fee_internal_wallet_guid Value to be assigned
    def network_fee_internal_wallet_guid=(network_fee_internal_wallet_guid)
      if !network_fee_internal_wallet_guid.nil? && network_fee_internal_wallet_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "network_fee_internal_wallet_guid", the character length must be smaller than or equal to 32.'
      end

      if !network_fee_internal_wallet_guid.nil? && network_fee_internal_wallet_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "network_fee_internal_wallet_guid", the character length must be great than or equal to 32.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] cybrid_account_guid Value to be assigned
    def cybrid_account_guid=(cybrid_account_guid)
      if !cybrid_account_guid.nil? && cybrid_account_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "cybrid_account_guid", the character length must be smaller than or equal to 32.'
      end

      if !cybrid_account_guid.nil? && cybrid_account_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "cybrid_account_guid", the character length must be great than or equal to 32.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          internal_wallet_guid == o.internal_wallet_guid &&
          network_fee_internal_wallet_guid == o.network_fee_internal_wallet_guid &&
          cybrid_account_guid == o.cybrid_account_guid &&
          asset == o.asset &&
    ...
    def hash
      [guid, environment, internal_wallet_guid, network_fee_internal_wallet_guid, cybrid_account_guid, asset, network_fee_asset, created_at, updated_at].hash
    end
