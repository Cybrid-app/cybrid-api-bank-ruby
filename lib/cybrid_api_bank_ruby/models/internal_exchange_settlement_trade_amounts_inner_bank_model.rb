...
module CybridApiBank
  class InternalExchangeSettlementTradeAmountsInnerBankModel
    # The asset code.
    attr_accessor :asset

    # The total payable amount in base units of the asset.
    attr_accessor :payable_amount

    # The total receivable amount in base units of the asset.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::InternalExchangeSettlementTradeAmountsInnerBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::InternalExchangeSettlementTradeAmountsInnerBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'receivable_amount')
        self.receivable_amount = attributes[:'receivable_amount']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @receivable_amount.nil?
        invalid_properties.push('invalid value for "receivable_amount", receivable_amount cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @receivable_amount.nil?
      true
    end
    ...
    def hash
      [asset, payable_amount, receivable_amount].hash
    end
