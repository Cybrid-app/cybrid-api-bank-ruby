...
module CybridApiBank
  class QuoteBankModel
    ...
    def hash
      [guid, product_type, bank_guid, customer_guid, symbol, side, receive_amount, deliver_amount, fee, created_at, updated_at, issued_at, expires_at, asset, network_fee, network_fee_asset, network_address, entries].hash
    end
