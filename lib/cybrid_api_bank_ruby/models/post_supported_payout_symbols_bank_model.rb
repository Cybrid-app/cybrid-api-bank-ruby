...
module CybridApiBank
  ...
  class PostSupportedPayoutSymbolsBankModel
    # The primary asset of the payout symbol, e.g., MXN.
    attr_accessor :primary_asset

    # The counter asset of the payout symbol, e.g., USD.
    attr_accessor :counter_asset
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostSupportedPayoutSymbolsBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostSupportedPayoutSymbolsBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'primary_asset')
        self.primary_asset = attributes[:'primary_asset']
      else
        self.primary_asset = nil
      end

      if attributes.key?(:'counter_asset')
        self.counter_asset = attributes[:'counter_asset']
      else
        self.counter_asset = nil
      end
    ...
    def list_invalid_properties
      ...
      if @primary_asset.nil?
        invalid_properties.push('invalid value for "primary_asset", primary_asset cannot be nil.')
      end

      if @counter_asset.nil?
        invalid_properties.push('invalid value for "counter_asset", counter_asset cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @primary_asset.nil?
      return false if @counter_asset.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          primary_asset == o.primary_asset &&
          counter_asset == o.counter_asset &&
    ...
    def hash
      [primary_asset, counter_asset, country_code, participants_type, route].hash
    end
