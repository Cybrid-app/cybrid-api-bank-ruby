...
module CybridApiBank
  ...
  class PostInternalBankBankModel
    ...
    def hash
      [organization_guid, type, name, supported_trading_symbols, supported_payout_symbols, supported_fiat_account_assets, supported_country_codes, features, cors_allowed_origins, persona_theme_id].hash
    end
