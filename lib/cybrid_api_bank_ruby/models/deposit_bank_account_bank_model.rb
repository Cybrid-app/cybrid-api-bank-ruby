...
module CybridApiBank
  class DepositBankAccountBankModel
    ...
    def hash
      [guid, name, type, bank_guid, customer_guid, account_guid, created_at, updated_at, deleted_at, asset, state, unique_memo_id, counterparty_name, counterparty_address, account_details, routing_details, parent_deposit_bank_account_guid, labels].hash
    end
