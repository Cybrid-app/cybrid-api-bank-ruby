...
module CybridApiBank
  ...
  class PostInternalExchangeSettlementBankModel
    ...
    def exchange_guid=(exchange_guid)
      if exchange_guid.nil?
        fail ArgumentError, 'exchange_guid cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] trade_guids Value to be assigned
    def trade_guids=(trade_guids)
      if !trade_guids.nil? && trade_guids.length > 225
        fail ArgumentError, 'invalid value for "trade_guids", number of items must be less than or equal to 225.'
      end

      if !trade_guids.nil? && trade_guids.length < 1
        fail ArgumentError, 'invalid value for "trade_guids", number of items must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] allowed_symbols Value to be assigned
    def allowed_symbols=(allowed_symbols)
      if !allowed_symbols.nil? && allowed_symbols.length > 50
        fail ArgumentError, 'invalid value for "allowed_symbols", number of items must be less than or equal to 50.'
      end

      if !allowed_symbols.nil? && allowed_symbols.length < 1
        fail ArgumentError, 'invalid value for "allowed_symbols", number of items must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] denied_symbols Value to be assigned
    def denied_symbols=(denied_symbols)
      if !denied_symbols.nil? && denied_symbols.length > 50
        fail ArgumentError, 'invalid value for "denied_symbols", number of items must be less than or equal to 50.'
      end

      if !denied_symbols.nil? && denied_symbols.length < 1
        fail ArgumentError, 'invalid value for "denied_symbols", number of items must be greater than or equal to 1.'
      end
