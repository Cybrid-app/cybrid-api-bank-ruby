...
module CybridApiBank
  class PatchInternalPaymentInstructionBankModel
    ...
    attr_accessor :expected_payment_asset

    # The amount to be paid in base units of expected_payment_asset.
    attr_accessor :expected_payment_amount
    ...
    def self.openapi_types
      {
        ...
        :'expected_payment_asset' => :'String',
        :'expected_payment_amount' => :'Integer',
        :'failure_code' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PatchInternalPaymentInstructionBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PatchInternalPaymentInstructionBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expected_payment_asset')
        self.expected_payment_asset = attributes[:'expected_payment_asset']
      end

      if attributes.key?(:'expected_payment_amount')
        self.expected_payment_amount = attributes[:'expected_payment_amount']
      end
    ...
    def valid?
      failure_code_validator = EnumAttributeValidator.new('String', ["invoice_paid", "invoice_cancelled", "invalid_amount"])
    ...
    def failure_code=(failure_code)
      validator = EnumAttributeValidator.new('String', ["invoice_paid", "invoice_cancelled", "invalid_amount"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          expected_payment_asset == o.expected_payment_asset &&
          expected_payment_amount == o.expected_payment_amount &&
    ...
    def hash
      [stored_at, expired_at, failed_at, network_address, expected_payment_asset, expected_payment_amount, failure_code].hash
    end
