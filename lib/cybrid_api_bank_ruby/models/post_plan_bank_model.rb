...
module CybridApiBank
  ...
  class PostPlanBankModel
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["remittance", "bill_pay", "disbursement", "invoice_pay"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["remittance", "bill_pay", "disbursement", "invoice_pay"])
