...
module CybridApiBank
  class InternalExchangeSettlementOrderAmountsInnerBankModel
    # The asset code.
    attr_accessor :asset

    # The total requested deliver amount in base units of the asset.
    attr_accessor :requested_deliver_amount

    # The total executed deliver amount in base units of the asset.
    attr_accessor :executed_deliver_amount

    # The total unassigned deliver amount in base units of the asset.
    attr_accessor :unassigned_deliver_amount

    # The total requested receive amount in base units of the asset.
    attr_accessor :requested_receive_amount

    # The total executed receive amount in base units of the asset.
    attr_accessor :executed_receive_amount

    # The total unassigned receive amount in base units of the asset.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::InternalExchangeSettlementOrderAmountsInnerBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::InternalExchangeSettlementOrderAmountsInnerBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @executed_deliver_amount.nil?
        invalid_properties.push('invalid value for "executed_deliver_amount", executed_deliver_amount cannot be nil.')
      end

      if @unassigned_deliver_amount.nil?
        invalid_properties.push('invalid value for "unassigned_deliver_amount", unassigned_deliver_amount cannot be nil.')
      end
      ...
      if @executed_receive_amount.nil?
        invalid_properties.push('invalid value for "executed_receive_amount", executed_receive_amount cannot be nil.')
      end

      if @unassigned_receive_amount.nil?
        invalid_properties.push('invalid value for "unassigned_receive_amount", unassigned_receive_amount cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @executed_deliver_amount.nil?
      return false if @unassigned_deliver_amount.nil?
      return false if @requested_receive_amount.nil?
      return false if @executed_receive_amount.nil?
      return false if @unassigned_receive_amount.nil?
      true
    end
    ...
    def hash
      [asset, requested_deliver_amount, executed_deliver_amount, unassigned_deliver_amount, requested_receive_amount, executed_receive_amount, unassigned_receive_amount].hash
    end
