...
module CybridApiBank
  ...
  class PostIdentificationNumberBankModel
    ...
    def list_invalid_properties
      ...
      if !@issuing_subdivision.nil? && @issuing_subdivision.to_s.length > 3
        invalid_properties.push('invalid value for "issuing_subdivision", the character length must be smaller than or equal to 3.')
      end

      if !@issuing_subdivision.nil? && @issuing_subdivision.to_s.length < 1
        invalid_properties.push('invalid value for "issuing_subdivision", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["drivers_license", "passport", "passport_card", "visa", "residence_card", "social_security_number", "tax_identification_number", "identification_card", "work_permit", "indigenous_document_number", "national_identification_number", "employer_identification_number", "business_registration_number"])
      return false unless type_validator.valid?(@type)
      return false if @issuing_country_code.nil?
      return false if @identification_number.nil?
      return false if !@issuing_subdivision.nil? && @issuing_subdivision.to_s.length > 3
      return false if !@issuing_subdivision.nil? && @issuing_subdivision.to_s.length < 1
      true
    end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["drivers_license", "passport", "passport_card", "visa", "residence_card", "social_security_number", "tax_identification_number", "identification_card", "work_permit", "indigenous_document_number", "national_identification_number", "employer_identification_number", "business_registration_number"])
    ...
    # @param [Object] issuing_subdivision Value to be assigned
    def issuing_subdivision=(issuing_subdivision)
      if !issuing_subdivision.nil? && issuing_subdivision.to_s.length > 3
        fail ArgumentError, 'invalid value for "issuing_subdivision", the character length must be smaller than or equal to 3.'
      end

      if !issuing_subdivision.nil? && issuing_subdivision.to_s.length < 1
        fail ArgumentError, 'invalid value for "issuing_subdivision", the character length must be great than or equal to 1.'
      end
    ...
    def hash
      [type, issuing_country_code, identification_number, issuing_subdivision].hash
    end
