...
module CybridApiBank
  ...
  class PostIdentificationNumberBankModel
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["drivers_license", "passport", "passport_card", "residence_card", "visa", "social_security_number", "tax_identification_number", "identification_card", "employer_identification_number", "business_registration_number"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["drivers_license", "passport", "passport_card", "residence_card", "visa", "social_security_number", "tax_identification_number", "identification_card", "employer_identification_number", "business_registration_number"])
