...
module CybridApiBank
  class PostInternalSystemTransactionBankModel
    ...
    attr_accessor :system_account_guid
    ...
    def self.attribute_map
      {
        ...
        :'system_account_guid' => :'system_account_guid',
        :'amount' => :'amount',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalSystemTransactionBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalSystemTransactionBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'system_account_guid')
        self.system_account_guid = attributes[:'system_account_guid']
      end
    ...
    def list_invalid_properties
      ...
      if @system_account_guid.nil?
        invalid_properties.push('invalid value for "system_account_guid", system_account_guid cannot be nil.')
      end

      if @system_account_guid.to_s.length > 32
        invalid_properties.push('invalid value for "system_account_guid", the character length must be smaller than or equal to 32.')
      end

      if @system_account_guid.to_s.length < 32
        invalid_properties.push('invalid value for "system_account_guid", the character length must be great than or equal to 32.')
      end
      ...
      if @asset_code.nil?
        invalid_properties.push('invalid value for "asset_code", asset_code cannot be nil.')
      end

      if @asset_code.to_s.length > 128
        invalid_properties.push('invalid value for "asset_code", the character length must be smaller than or equal to 128.')
      end

      if @asset_code.to_s.length < 1
    ...
    def valid?
      ...
      return false if @system_account_guid.nil?
      return false if @system_account_guid.to_s.length > 32
      return false if @system_account_guid.to_s.length < 32
      return false if @amount.nil?
      return false if @asset_code.nil?
      return false if @asset_code.to_s.length > 128
      return false if @asset_code.to_s.length < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] system_account_guid Value to be assigned
    def system_account_guid=(system_account_guid)
      if system_account_guid.nil?
        fail ArgumentError, 'system_account_guid cannot be nil'
      end

      if system_account_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "system_account_guid", the character length must be smaller than or equal to 32.'
      end

      if system_account_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "system_account_guid", the character length must be great than or equal to 32.'
      end
    ...
    def asset_code=(asset_code)
      if asset_code.nil?
        fail ArgumentError, 'asset_code cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          system_account_guid == o.system_account_guid &&
          amount == o.amount &&
    ...
    def hash
      [guid, provider_id, system_account_guid, amount, asset_code, direction, details].hash
    end
