...
module CybridApiBank
  class PostInternalInternalWalletConfigurationBankModel
    ...
    # The identifier of the internal wallet to use for transfers.
    attr_accessor :transfer_wallet_guid

    # The identifier of the internal wallet to use for invoices. This must be a Strike internal wallet.
    attr_accessor :invoice_wallet_guid

    # The identifier of the internal wallet to use for storage. This must be a BitGo internal wallet.
    attr_accessor :storage_wallet_guid
    ...
    def self.attribute_map
      {
        ...
        :'bank_guid' => :'bank_guid',
        :'transfer_wallet_guid' => :'transfer_wallet_guid',
        :'invoice_wallet_guid' => :'invoice_wallet_guid',
        :'storage_wallet_guid' => :'storage_wallet_guid',
        :'asset' => :'asset'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'environment' => :'String',
        :'bank_guid' => :'String',
        :'transfer_wallet_guid' => :'String',
        :'invoice_wallet_guid' => :'String',
        :'storage_wallet_guid' => :'String',
        :'asset' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalInternalWalletConfigurationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalInternalWalletConfigurationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transfer_wallet_guid')
        self.transfer_wallet_guid = attributes[:'transfer_wallet_guid']
      end

      if attributes.key?(:'invoice_wallet_guid')
        self.invoice_wallet_guid = attributes[:'invoice_wallet_guid']
      end

      if attributes.key?(:'storage_wallet_guid')
        self.storage_wallet_guid = attributes[:'storage_wallet_guid']
      end
    ...
    def list_invalid_properties
      ...
      if @transfer_wallet_guid.nil?
        invalid_properties.push('invalid value for "transfer_wallet_guid", transfer_wallet_guid cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@bank_guid.nil? && @bank_guid.to_s.length < 32
      return false if @transfer_wallet_guid.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transfer_wallet_guid == o.transfer_wallet_guid &&
          invoice_wallet_guid == o.invoice_wallet_guid &&
          storage_wallet_guid == o.storage_wallet_guid &&
          asset == o.asset
    end
    ...
    def hash
      [type, environment, bank_guid, transfer_wallet_guid, invoice_wallet_guid, storage_wallet_guid, asset].hash
    end
