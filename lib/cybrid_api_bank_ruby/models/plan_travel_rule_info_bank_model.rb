...
module CybridApiBank
  ...
  class PlanTravelRuleInfoBankModel
    attr_accessor :originating_party

    attr_accessor :receiving_party

    attr_accessor :ultimate_originating_party

    attr_accessor :ultimate_receiving_party
    ...
    def self.attribute_map
      {
        ...
        :'ultimate_originating_party' => :'ultimate_originating_party',
        :'ultimate_receiving_party' => :'ultimate_receiving_party'
      }
    end
    ...
    def self.openapi_types
      {
        :'originating_party' => :'TravelRuleInfoPartyBankModel',
        :'receiving_party' => :'TravelRuleInfoPartyBankModel',
        :'ultimate_originating_party' => :'TravelRuleInfoPartyBankModel',
        :'ultimate_receiving_party' => :'TravelRuleInfoPartyBankModel'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PlanTravelRuleInfoBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PlanTravelRuleInfoBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'originating_party')
        self.originating_party = attributes[:'originating_party']
      else
        self.originating_party = nil
      end

      if attributes.key?(:'receiving_party')
        self.receiving_party = attributes[:'receiving_party']
      else
        self.receiving_party = nil
      end

      if attributes.key?(:'ultimate_originating_party')
        self.ultimate_originating_party = attributes[:'ultimate_originating_party']
      end

      if attributes.key?(:'ultimate_receiving_party')
        self.ultimate_receiving_party = attributes[:'ultimate_receiving_party']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @originating_party.nil?
        invalid_properties.push('invalid value for "originating_party", originating_party cannot be nil.')
      end

      if @receiving_party.nil?
        invalid_properties.push('invalid value for "receiving_party", receiving_party cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @originating_party.nil?
      return false if @receiving_party.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          originating_party == o.originating_party &&
          receiving_party == o.receiving_party &&
          ultimate_originating_party == o.ultimate_originating_party &&
          ultimate_receiving_party == o.ultimate_receiving_party
    end
    ...
    def hash
      [originating_party, receiving_party, ultimate_originating_party, ultimate_receiving_party].hash
    end
