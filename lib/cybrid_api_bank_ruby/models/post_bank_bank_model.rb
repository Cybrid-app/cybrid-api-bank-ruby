...
module CybridApiBank
  class PostBankBankModel
    ...
    def list_invalid_properties
      ...
      if !@supported_country_codes.nil? && @supported_country_codes.length > 1
    ...
    def valid?
      ...
      return false if @supported_fiat_account_assets.length < 1
      return false if !@supported_country_codes.nil? && @supported_country_codes.length > 1
      return false if !@supported_country_codes.nil? && @supported_country_codes.length < 1
      true
    end
    ...
    def hash
      [name, type, supported_trading_symbols, features, supported_fiat_account_assets, supported_country_codes].hash
    end
