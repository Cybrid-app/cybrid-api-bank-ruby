...
module CybridApiBank
  ...
  class PostBankBankModel
    ...
    attr_accessor :supported_fiat_account_assets

    # The country codes supported by the bank.
    attr_accessor :supported_country_codes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostBankBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostBankBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'supported_trading_symbols')
        ...
        self.supported_trading_symbols = nil
      end
      ...
      if attributes.key?(:'supported_fiat_account_assets')
        if (value = attributes[:'supported_fiat_account_assets']).is_a?(Array)
          self.supported_fiat_account_assets = value
        end
      else
        self.supported_fiat_account_assets = nil
      end
      ...
      if attributes.key?(:'supported_country_codes')
        ...
        self.supported_country_codes = nil
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["sandbox"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["sandbox"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] supported_trading_symbols Value to be assigned
    def supported_trading_symbols=(supported_trading_symbols)
      if supported_trading_symbols.nil?
        fail ArgumentError, 'supported_trading_symbols cannot be nil'
      end

      if supported_trading_symbols.length > 50
        fail ArgumentError, 'invalid value for "supported_trading_symbols", number of items must be less than or equal to 50.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] supported_fiat_account_assets Value to be assigned
    def supported_fiat_account_assets=(supported_fiat_account_assets)
      if supported_fiat_account_assets.nil?
        fail ArgumentError, 'supported_fiat_account_assets cannot be nil'
      end

      if supported_fiat_account_assets.length > 1
        fail ArgumentError, 'invalid value for "supported_fiat_account_assets", number of items must be less than or equal to 1.'
      end

      if supported_fiat_account_assets.length < 1
        fail ArgumentError, 'invalid value for "supported_fiat_account_assets", number of items must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] supported_country_codes Value to be assigned
    def supported_country_codes=(supported_country_codes)
      if supported_country_codes.nil?
        fail ArgumentError, 'supported_country_codes cannot be nil'
      end

      if supported_country_codes.length > 1
        fail ArgumentError, 'invalid value for "supported_country_codes", number of items must be less than or equal to 1.'
      end

      if supported_country_codes.length < 1
        fail ArgumentError, 'invalid value for "supported_country_codes", number of items must be greater than or equal to 1.'
      end
    ...
    def cors_allowed_origins=(cors_allowed_origins)
      if !cors_allowed_origins.nil? && cors_allowed_origins.length > 50
        fail ArgumentError, 'invalid value for "cors_allowed_origins", number of items must be less than or equal to 50.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          supported_fiat_account_assets == o.supported_fiat_account_assets &&
    ...
    def hash
      [type, name, supported_trading_symbols, supported_payout_symbols, supported_fiat_account_assets, supported_country_codes, features, cors_allowed_origins].hash
    end
