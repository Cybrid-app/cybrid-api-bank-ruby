...
module CybridApiBank
  class PostAccountBankModel
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["trading", "fiat", "invoice_operations"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["trading", "fiat", "invoice_operations"])
