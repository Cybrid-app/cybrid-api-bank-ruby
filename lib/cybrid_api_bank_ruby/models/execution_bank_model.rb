...
module CybridApiBank
  class ExecutionBankModel
    ...
    def hash
      [guid, type, plan_guid, bank_guid, customer_guid, created_at, updated_at, state, failure_code, source_account, destination_account, stages, fees, holds, travel_rule_info, purpose_of_transaction, references, labels].hash
    end
