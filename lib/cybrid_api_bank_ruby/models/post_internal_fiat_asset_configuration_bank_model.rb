...
module CybridApiBank
  class PostInternalFiatAssetConfigurationBankModel
    ...
    # The maximum number of accounts allowed for the asset on the platform. Must be omitted or set to nil if enabled is False.
    attr_accessor :maximum_number_of_accounts

    # The maximum funding quote amounts by rail for the asset.
    attr_accessor :maximum_funding_quote_amount
    ...
    def self.attribute_map
      {
        ...
        :'maximum_funding_quote_amount' => :'maximum_funding_quote_amount',
        :'asset' => :'asset'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'maximum_number_of_accounts' => :'Integer',
        :'maximum_funding_quote_amount' => :'Object',
        :'asset' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalFiatAssetConfigurationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalFiatAssetConfigurationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'maximum_number_of_accounts')
        self.maximum_number_of_accounts = attributes[:'maximum_number_of_accounts']
      end

      if attributes.key?(:'maximum_funding_quote_amount')
        self.maximum_funding_quote_amount = attributes[:'maximum_funding_quote_amount']
      end
    ...
    def list_invalid_properties
      ...
      if !@maximum_number_of_accounts.nil? && @maximum_number_of_accounts < 1
        invalid_properties.push('invalid value for "maximum_number_of_accounts", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@maximum_number_of_accounts.nil? && @maximum_number_of_accounts < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] maximum_number_of_accounts Value to be assigned
    def maximum_number_of_accounts=(maximum_number_of_accounts)
      if !maximum_number_of_accounts.nil? && maximum_number_of_accounts < 1
        fail ArgumentError, 'invalid value for "maximum_number_of_accounts", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          maximum_number_of_accounts == o.maximum_number_of_accounts &&
          maximum_funding_quote_amount == o.maximum_funding_quote_amount &&
          asset == o.asset
    end
    ...
    def hash
      [type, environment, bank_guid, enabled, invoices_enabled, maximum_number_of_accounts, maximum_funding_quote_amount, asset].hash
    end
