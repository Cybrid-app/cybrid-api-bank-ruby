...
module CybridApiBank
  ...
  class PostPaymentInstructionBankModel
    ...
    attr_accessor :expected_behaviour
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostPaymentInstructionBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostPaymentInstructionBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'invoice_guid')
        self.invoice_guid = attributes[:'invoice_guid']
      end

      if attributes.key?(:'expected_behaviour')
        self.expected_behaviour = attributes[:'expected_behaviour']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @invoice_guid.nil?
        invalid_properties.push('invalid value for "invoice_guid", invoice_guid cannot be nil.')
      end
    ...
    # @param [Object] invoice_guid Value to be assigned
    def invoice_guid=(invoice_guid)
      if invoice_guid.nil?
        fail ArgumentError, 'invoice_guid cannot be nil'
      end
    ...
    # @param [Object] expected_behaviour Object to be assigned
    def expected_behaviour=(expected_behaviour)
      validator = EnumAttributeValidator.new('String', ["invoice_paid_immediately"])
      unless validator.valid?(expected_behaviour)
        fail ArgumentError, "invalid value for \"expected_behaviour\", must be one of #{validator.allowable_values}."
      end
      @expected_behaviour = expected_behaviour
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          invoice_guid == o.invoice_guid &&
          expected_behaviour == o.expected_behaviour
    end
    ...
    def hash
      [invoice_guid, expected_behaviour].hash
    end
