...
module CybridApiBank
  class PostInternalInternalBankAccountBankModel
    ...
    attr_accessor :bank_account_service_guid
    ...
    def self.openapi_types
      {
        ...
        :'environment' => :'String',
        :'provider_id' => :'String',
        :'bank_account_service_guid' => :'String',
        :'routing_details' => :'Array<PostInternalInternalBankAccountRoutingDetailBankModel>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalInternalBankAccountBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalInternalBankAccountBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'bank_account_service_guid')
        self.bank_account_service_guid = attributes[:'bank_account_service_guid']
      end
    ...
    def list_invalid_properties
      ...
      if @provider_id.to_s.length > 128
      ...
      if @bank_account_service_guid.nil?
        invalid_properties.push('invalid value for "bank_account_service_guid", bank_account_service_guid cannot be nil.')
      end

      if @bank_account_service_guid.to_s.length > 32
        invalid_properties.push('invalid value for "bank_account_service_guid", the character length must be smaller than or equal to 32.')
      end

      if @bank_account_service_guid.to_s.length < 32
        invalid_properties.push('invalid value for "bank_account_service_guid", the character length must be great than or equal to 32.')
      end
    ...
    def valid?
      ...
      account_kind_validator = EnumAttributeValidator.new('String', ["circle_master_wallet", "modern_treasury_internal_account", "strike_account", "falconx_account", "aquanow_account", "bitso_account"])
      ...
      return false if @provider_id.to_s.length > 128
      return false if @provider_id.to_s.length < 1
      return false if @bank_account_service_guid.nil?
      return false if @bank_account_service_guid.to_s.length > 32
      return false if @bank_account_service_guid.to_s.length < 32
      true
    end
    ...
    def account_kind=(account_kind)
      validator = EnumAttributeValidator.new('String', ["circle_master_wallet", "modern_treasury_internal_account", "strike_account", "falconx_account", "aquanow_account", "bitso_account"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] bank_account_service_guid Value to be assigned
    def bank_account_service_guid=(bank_account_service_guid)
      if bank_account_service_guid.nil?
        fail ArgumentError, 'bank_account_service_guid cannot be nil'
      end

      if bank_account_service_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "bank_account_service_guid", the character length must be smaller than or equal to 32.'
      end

      if bank_account_service_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "bank_account_service_guid", the character length must be great than or equal to 32.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bank_account_service_guid == o.bank_account_service_guid &&
    ...
    def hash
      [name, asset, account_kind, environment, provider_id, bank_account_service_guid, routing_details].hash
    end
