...
module CybridApiBank
  class PlanBankModel
    ...
    def hash
      [guid, type, bank_guid, customer_guid, created_at, updated_at, expires_at, state, failure_code, source_account, destination_account, stages, fees, travel_rule_info, purpose_of_transaction, supporting_documents].hash
    end
