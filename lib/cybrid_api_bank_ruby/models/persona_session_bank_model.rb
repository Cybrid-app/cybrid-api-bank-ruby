  ...
  class PersonaSessionBankModel
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PersonaSessionBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PersonaSessionBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'identity_verification_guid')
        ...
        self.identity_verification_guid = nil
      end

      if attributes.key?(:'persona_inquiry_id')
        self.persona_inquiry_id = attributes[:'persona_inquiry_id']
      else
        self.persona_inquiry_id = nil
      end

      if attributes.key?(:'persona_session_token')
        self.persona_session_token = attributes[:'persona_session_token']
      else
        self.persona_session_token = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @identity_verification_guid.nil?
        invalid_properties.push('invalid value for "identity_verification_guid", identity_verification_guid cannot be nil.')
      end

      if @persona_inquiry_id.nil?
        invalid_properties.push('invalid value for "persona_inquiry_id", persona_inquiry_id cannot be nil.')
      end

      if @persona_session_token.nil?
        invalid_properties.push('invalid value for "persona_session_token", persona_session_token cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @identity_verification_guid.nil?
      return false if @persona_inquiry_id.nil?
      return false if @persona_session_token.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          persona_session_token == o.persona_session_token
    end
    ...
    def hash
      [identity_verification_guid, persona_inquiry_id, persona_session_token].hash
    end
