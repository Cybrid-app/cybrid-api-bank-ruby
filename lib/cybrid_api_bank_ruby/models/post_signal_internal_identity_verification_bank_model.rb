...
module CybridApiBank
  class PostSignalInternalIdentityVerificationBankModel
    ...
    attr_accessor :bank_account_holder_address
    ...
    def self.openapi_types
      {
        :'reference_id' => :'String',
        :'comment' => :'String',
        :'bank_account_holder_name' => :'PostSignalInternalIdentityVerificationBankAccountHolderNameBankModel',
        :'bank_account_holder_address' => :'PostSignalInternalIdentityVerificationBankAccountHolderAddressBankModel',
        :'decision' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostSignalInternalIdentityVerificationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostSignalInternalIdentityVerificationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'bank_account_holder_address')
        self.bank_account_holder_address = attributes[:'bank_account_holder_address']
      end
    ...
    def list_invalid_properties
      ...
      if @failure_codes.nil?
        invalid_properties.push('invalid value for "failure_codes", failure_codes cannot be nil.')
      end
    ...
    def valid?
      ...
      decision_validator = EnumAttributeValidator.new('String', ["passed", "failed"])
      return false unless decision_validator.valid?(@decision)
      return false if @failure_codes.nil?
      true
    end
    ...
    def decision=(decision)
      validator = EnumAttributeValidator.new('String', ["passed", "failed"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bank_account_holder_address == o.bank_account_holder_address &&
          decision == o.decision &&
    ...
    def hash
      [reference_id, comment, bank_account_holder_name, bank_account_holder_address, decision, failure_codes].hash
    end
