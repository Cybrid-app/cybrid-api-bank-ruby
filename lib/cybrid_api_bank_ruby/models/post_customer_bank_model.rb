...
module CybridApiBank
  ...
  class PostCustomerBankModel
    ...
    def self.openapi_types
      {
        ...
        :'date_of_birth' => :'Date',
        :'aliases' => :'Array<PostCustomerAliasesInnerBankModel>',
        :'website' => :'String',
        :'labels' => :'Array<String>'
      }
    end
    ...
    def aliases=(aliases)
      if !aliases.nil? && aliases.length > 1
        fail ArgumentError, 'invalid value for "aliases", number of items must be less than or equal to 1.'
      end
    ...
    def hash
      [type, address, phone_number, email_address, identification_numbers, name, date_of_birth, aliases, website, labels].hash
    end
