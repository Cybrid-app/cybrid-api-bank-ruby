...
module CybridApiBank
  ...
  class PostInternalExchangeSettlementConfigurationBankModel
    # The asset code for the settlement configuration.
    attr_accessor :asset
    ...
    attr_accessor :omnibus_account_guid

    # The exchange account identifier.
    attr_accessor :exchange_account_guid
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalExchangeSettlementConfigurationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalExchangeSettlementConfigurationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'omnibus_account_guid')
        self.omnibus_account_guid = attributes[:'omnibus_account_guid']
      end

      if attributes.key?(:'exchange_account_guid')
        self.exchange_account_guid = attributes[:'exchange_account_guid']
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] omnibus_account_guid Value to be assigned
    def omnibus_account_guid=(omnibus_account_guid)
      if !omnibus_account_guid.nil? && omnibus_account_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "omnibus_account_guid", the character length must be smaller than or equal to 32.'
      end

      if !omnibus_account_guid.nil? && omnibus_account_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "omnibus_account_guid", the character length must be great than or equal to 32.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] exchange_account_guid Value to be assigned
    def exchange_account_guid=(exchange_account_guid)
      if exchange_account_guid.nil?
        fail ArgumentError, 'exchange_account_guid cannot be nil'
      end

      if exchange_account_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "exchange_account_guid", the character length must be smaller than or equal to 32.'
      end

      if exchange_account_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "exchange_account_guid", the character length must be great than or equal to 32.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          omnibus_account_guid == o.omnibus_account_guid &&
          exchange_account_guid == o.exchange_account_guid
    end
    ...
    def hash
      [asset, exchange_guid, omnibus_account_guid, exchange_account_guid].hash
    end
