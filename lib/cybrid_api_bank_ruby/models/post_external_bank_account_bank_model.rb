...
module CybridApiBank
  class PostExternalBankAccountBankModel
    ...
    def hash
      [name, account_kind, customer_guid, asset, plaid_public_token, plaid_account_id, plaid_processor_token, plaid_institution_id, plaid_account_mask, plaid_account_name, counterparty_bank_account, counterparty_name, counterparty_address, counterparty_email_address].hash
    end
