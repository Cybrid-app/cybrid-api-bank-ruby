...
module CybridApiBank
  ...
  class PostExternalBankAccountBankModel
    ...
    attr_accessor :counterparty_bank_account_details
    ...
    def self.attribute_map
      {
        ...
        :'counterparty_bank_account_details' => :'counterparty_bank_account_details',
    ...
    def self.openapi_types
      {
        ...
        :'counterparty_bank_account_details' => :'Array<PostBankAccountDetailsBankModel>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'counterparty_bank_account_details')
        if (value = attributes[:'counterparty_bank_account_details']).is_a?(Array)
          self.counterparty_bank_account_details = value
        end
      end
    ...
    def valid?
      ...
      account_kind_validator = EnumAttributeValidator.new('String', ["plaid", "plaid_processor_token", "raw_routing_details"])
    ...
    def account_kind=(account_kind)
      validator = EnumAttributeValidator.new('String', ["plaid", "plaid_processor_token", "raw_routing_details"])
    ...
    def plaid_public_token=(plaid_public_token)
      if !plaid_public_token.nil? && plaid_public_token.to_s.length > 128
        fail ArgumentError, 'invalid value for "plaid_public_token", the character length must be smaller than or equal to 128.'
      end

      if !plaid_public_token.nil? && plaid_public_token.to_s.length < 1
        fail ArgumentError, 'invalid value for "plaid_public_token", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] plaid_account_id Value to be assigned
    def plaid_account_id=(plaid_account_id)
      if !plaid_account_id.nil? && plaid_account_id.to_s.length > 128
        fail ArgumentError, 'invalid value for "plaid_account_id", the character length must be smaller than or equal to 128.'
      end

      if !plaid_account_id.nil? && plaid_account_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "plaid_account_id", the character length must be great than or equal to 1.'
      end
    ...
    def plaid_processor_token=(plaid_processor_token)
      if !plaid_processor_token.nil? && plaid_processor_token.to_s.length > 128
        fail ArgumentError, 'invalid value for "plaid_processor_token", the character length must be smaller than or equal to 128.'
      end

      if !plaid_processor_token.nil? && plaid_processor_token.to_s.length < 1
        fail ArgumentError, 'invalid value for "plaid_processor_token", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] plaid_institution_id Value to be assigned
    def plaid_institution_id=(plaid_institution_id)
      if !plaid_institution_id.nil? && plaid_institution_id.to_s.length > 128
        fail ArgumentError, 'invalid value for "plaid_institution_id", the character length must be smaller than or equal to 128.'
      end

      if !plaid_institution_id.nil? && plaid_institution_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "plaid_institution_id", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] plaid_account_mask Value to be assigned
    def plaid_account_mask=(plaid_account_mask)
      if !plaid_account_mask.nil? && plaid_account_mask.to_s.length > 128
        fail ArgumentError, 'invalid value for "plaid_account_mask", the character length must be smaller than or equal to 128.'
      end

      if !plaid_account_mask.nil? && plaid_account_mask.to_s.length < 1
        fail ArgumentError, 'invalid value for "plaid_account_mask", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] plaid_account_name Value to be assigned
    def plaid_account_name=(plaid_account_name)
      if !plaid_account_name.nil? && plaid_account_name.to_s.length > 128
        fail ArgumentError, 'invalid value for "plaid_account_name", the character length must be smaller than or equal to 128.'
      end

      if !plaid_account_name.nil? && plaid_account_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "plaid_account_name", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          counterparty_bank_account_details == o.counterparty_bank_account_details &&
    ...
    def hash
      [name, account_kind, customer_guid, asset, plaid_public_token, plaid_account_id, plaid_processor_token, plaid_institution_id, plaid_account_mask, plaid_account_name, counterparty_guid, counterparty_bank_account_details, counterparty_name, counterparty_address, counterparty_email_address].hash
    end
