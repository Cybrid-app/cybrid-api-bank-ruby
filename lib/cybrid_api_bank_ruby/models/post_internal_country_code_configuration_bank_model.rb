...
module CybridApiBank
  class PostInternalCountryCodeConfigurationBankModel
    ...
    attr_accessor :jurisdiction_enabled

    # Flag indicating if the country code is configured for business customers.
    attr_accessor :business_customers_enabled

    # Flag indicating if the country code is configured for individual customers.
    attr_accessor :individual_customers_enabled

    # Flag indicating if the country code is configured for business counterparties.
    attr_accessor :business_counterparties_enabled

    # Flag indicating if the country code is configured for individual counterparties.
    attr_accessor :individual_counterparties_enabled
    ...
    def self.attribute_map
      {
        ...
        :'business_customers_enabled' => :'business_customers_enabled',
        :'individual_customers_enabled' => :'individual_customers_enabled',
        :'business_counterparties_enabled' => :'business_counterparties_enabled',
        :'individual_counterparties_enabled' => :'individual_counterparties_enabled',
        :'code' => :'code'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostInternalCountryCodeConfigurationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostInternalCountryCodeConfigurationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'jurisdiction_enabled')
        self.jurisdiction_enabled = attributes[:'jurisdiction_enabled']
      end

      if attributes.key?(:'business_customers_enabled')
        self.business_customers_enabled = attributes[:'business_customers_enabled']
      end

      if attributes.key?(:'individual_customers_enabled')
        self.individual_customers_enabled = attributes[:'individual_customers_enabled']
      end

      if attributes.key?(:'business_counterparties_enabled')
        self.business_counterparties_enabled = attributes[:'business_counterparties_enabled']
      end

      if attributes.key?(:'individual_counterparties_enabled')
        self.individual_counterparties_enabled = attributes[:'individual_counterparties_enabled']
      end
    ...
    def list_invalid_properties
      ...
      if @jurisdiction_enabled.nil?
        invalid_properties.push('invalid value for "jurisdiction_enabled", jurisdiction_enabled cannot be nil.')
      end

      if @business_customers_enabled.nil?
        invalid_properties.push('invalid value for "business_customers_enabled", business_customers_enabled cannot be nil.')
      end

      if @individual_customers_enabled.nil?
        invalid_properties.push('invalid value for "individual_customers_enabled", individual_customers_enabled cannot be nil.')
      end

      if @business_counterparties_enabled.nil?
        invalid_properties.push('invalid value for "business_counterparties_enabled", business_counterparties_enabled cannot be nil.')
      end

      if @individual_counterparties_enabled.nil?
        invalid_properties.push('invalid value for "individual_counterparties_enabled", individual_counterparties_enabled cannot be nil.')
      end
      ...
      if @code.to_s.length > 16
        invalid_properties.push('invalid value for "code", the character length must be smaller than or equal to 16.')
      end
    ...
    def valid?
      ...
      return false if !@bank_guid.nil? && @bank_guid.to_s.length < 32
      return false if @jurisdiction_enabled.nil?
      return false if @business_customers_enabled.nil?
      return false if @individual_customers_enabled.nil?
      return false if @business_counterparties_enabled.nil?
      return false if @individual_counterparties_enabled.nil?
      return false if @code.nil?
      return false if @code.to_s.length > 16
    ...
    def code=(code)
      ...
      if code.to_s.length > 16
        fail ArgumentError, 'invalid value for "code", the character length must be smaller than or equal to 16.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          jurisdiction_enabled == o.jurisdiction_enabled &&
          business_customers_enabled == o.business_customers_enabled &&
          individual_customers_enabled == o.individual_customers_enabled &&
          business_counterparties_enabled == o.business_counterparties_enabled &&
    ...
    def hash
      [type, environment, bank_guid, jurisdiction_enabled, business_customers_enabled, individual_customers_enabled, business_counterparties_enabled, individual_counterparties_enabled, code].hash
    end
