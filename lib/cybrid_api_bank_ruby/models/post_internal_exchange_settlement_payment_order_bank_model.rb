...
module CybridApiBank
  class PostInternalExchangeSettlementPaymentOrderBankModel
    ...
    attr_accessor :internal_network_fee_wallet_guid
    ...
    def exchange_settlement_guid=(exchange_settlement_guid)
      if exchange_settlement_guid.nil?
        fail ArgumentError, 'exchange_settlement_guid cannot be nil'
      end
    ...
    def exchange_settlement_obligation_guid=(exchange_settlement_obligation_guid)
      if exchange_settlement_obligation_guid.nil?
        fail ArgumentError, 'exchange_settlement_obligation_guid cannot be nil'
      end
    ...
    # @param [Object] expected_state Object to be assigned
    def expected_state=(expected_state)
      validator = EnumAttributeValidator.new('String', ["pending", "in_progress", "completed", "failed", "cancelled", "manual_intervention"])
      unless validator.valid?(expected_state)
        fail ArgumentError, "invalid value for \"expected_state\", must be one of #{validator.allowable_values}."
      end
      @expected_state = expected_state
    end
    ...
    def internal_account_guid=(internal_account_guid)
      if internal_account_guid.nil?
        fail ArgumentError, 'internal_account_guid cannot be nil'
      end
    ...
    def external_account_guid=(external_account_guid)
      if external_account_guid.nil?
        fail ArgumentError, 'external_account_guid cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] internal_network_fee_wallet_guid Value to be assigned
    def internal_network_fee_wallet_guid=(internal_network_fee_wallet_guid)
      if !internal_network_fee_wallet_guid.nil? && internal_network_fee_wallet_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "internal_network_fee_wallet_guid", the character length must be smaller than or equal to 32.'
      end

      if !internal_network_fee_wallet_guid.nil? && internal_network_fee_wallet_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "internal_network_fee_wallet_guid", the character length must be great than or equal to 32.'
      end
    ...
    def hash
      [exchange_settlement_guid, exchange_settlement_obligation_guid, sequence_number, payment_amount, network_fee, expected_state, internal_account_guid, internal_account_type, external_account_guid, external_account_type, network_fee_account_guid, internal_network_fee_wallet_guid].hash
    end
