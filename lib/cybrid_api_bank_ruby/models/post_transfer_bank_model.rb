...
module CybridApiBank
  class PostTransferBankModel
    ...
    def list_invalid_properties
      ...
      if !@send_as_deposit_bank_account_guid.nil? && @send_as_deposit_bank_account_guid.to_s.length < 32
        invalid_properties.push('invalid value for "send_as_deposit_bank_account_guid", the character length must be great than or equal to 32.')
      end
    ...
    def customer_fiat_account_guid=(customer_fiat_account_guid)
      ...
      if !customer_fiat_account_guid.nil? && customer_fiat_account_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "customer_fiat_account_guid", the character length must be great than or equal to 32.'
      end
    ...
    def bank_fiat_account_guid=(bank_fiat_account_guid)
      ...
      if !bank_fiat_account_guid.nil? && bank_fiat_account_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "bank_fiat_account_guid", the character length must be great than or equal to 32.'
      end
    ...
    def hash
      [quote_guid, transfer_type, customer_guid, fiat_account_guid, customer_fiat_account_guid, bank_fiat_account_guid, source_account_guid, source_participants, destination_account_guid, destination_participants, external_wallet_guid, external_bank_account_guid, network_fee_account_guid, payment_rail, beneficiary_memo, send_as_deposit_bank_account_guid, labels].hash
    end
