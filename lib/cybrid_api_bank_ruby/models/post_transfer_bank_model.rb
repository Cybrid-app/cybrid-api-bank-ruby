...
module CybridApiBank
  ...
  class PostTransferBankModel
    ...
    def hash
      [quote_guid, transfer_type, external_bank_account_guid, fiat_account_guid, send_as_deposit_bank_account_guid, payment_rail, beneficiary_memo, security_question, security_answer, source_participants, destination_participants, bank_fiat_account_guid, customer_fiat_account_guid, source_account_guid, destination_account_guid, external_wallet_guid, customer_guid, network_fee_account_guid, expected_behaviours, labels].hash
    end
