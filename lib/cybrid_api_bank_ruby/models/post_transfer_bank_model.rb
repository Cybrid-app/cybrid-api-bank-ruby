...
module CybridApiBank
  ...
  class PostTransferBankModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'security_answer')
        self.security_answer = attributes[:'security_answer']
      end
    ...
    def list_invalid_properties
      ...
      if !@security_question.nil? && @security_question.to_s.length > 40
        invalid_properties.push('invalid value for "security_question", the character length must be smaller than or equal to 40.')
      end

      if !@security_answer.nil? && @security_answer.to_s.length > 25
        invalid_properties.push('invalid value for "security_answer", the character length must be smaller than or equal to 25.')
      end
    ...
    def valid?
      ...
      transfer_type_validator = EnumAttributeValidator.new('String', ["funding", "crypto", "instant_funding", "inter_account", "lightning", "book"])
      ...
      return false if !@security_question.nil? && @security_question.to_s.length > 40
      return false if !@security_answer.nil? && @security_answer.to_s.length > 25
    ...
    def transfer_type=(transfer_type)
      validator = EnumAttributeValidator.new('String', ["funding", "crypto", "instant_funding", "inter_account", "lightning", "book"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] security_question Value to be assigned
    def security_question=(security_question)
      if !security_question.nil? && security_question.to_s.length > 40
        fail ArgumentError, 'invalid value for "security_question", the character length must be smaller than or equal to 40.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] security_answer Value to be assigned
    def security_answer=(security_answer)
      if !security_answer.nil? && security_answer.to_s.length > 25
        fail ArgumentError, 'invalid value for "security_answer", the character length must be smaller than or equal to 25.'
      end
    ...
    def hash
      [quote_guid, transfer_type, external_bank_account_guid, fiat_account_guid, send_as_deposit_bank_account_guid, payment_rail, beneficiary_memo, security_question, security_answer, source_participants, destination_participants, sardine_session_guid, bank_fiat_account_guid, customer_fiat_account_guid, source_account_guid, destination_account_guid, external_wallet_guid, customer_guid, network_fee_account_guid, expected_behaviours, labels].hash
    end
