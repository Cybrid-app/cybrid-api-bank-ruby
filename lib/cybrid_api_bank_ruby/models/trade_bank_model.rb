...
module CybridApiBank
  class TradeBankModel
    ...
    def hash
      [guid, trade_type, customer_guid, quote_guid, symbol, side, state, failure_code, receive_amount, deliver_amount, fee, reference_trade_guid, created_at, updated_at, labels].hash
    end
