...
module CybridApiBank
  ...
  class PostExecutionBankModel
    # The unique identifier for the plan.
    attr_accessor :plan_guid
    ...
    attr_accessor :sardine_session_guid

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'plan_guid' => :'plan_guid',
        :'sardine_session_guid' => :'sardine_session_guid'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PostExecutionBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PostExecutionBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sardine_session_guid')
        self.sardine_session_guid = attributes[:'sardine_session_guid']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@sardine_session_guid.nil? && @sardine_session_guid.to_s.length > 32
        invalid_properties.push('invalid value for "sardine_session_guid", the character length must be smaller than or equal to 32.')
      end

      if !@sardine_session_guid.nil? && @sardine_session_guid.to_s.length < 32
        invalid_properties.push('invalid value for "sardine_session_guid", the character length must be great than or equal to 32.')
      end
    ...
    def valid?
      ...
      return false if @plan_guid.to_s.length < 32
      return false if !@sardine_session_guid.nil? && @sardine_session_guid.to_s.length > 32
      return false if !@sardine_session_guid.nil? && @sardine_session_guid.to_s.length < 32
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] plan_guid Value to be assigned
    def plan_guid=(plan_guid)
      if plan_guid.nil?
        fail ArgumentError, 'plan_guid cannot be nil'
      end

      if plan_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "plan_guid", the character length must be smaller than or equal to 32.'
      end

      if plan_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "plan_guid", the character length must be great than or equal to 32.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] sardine_session_guid Value to be assigned
    def sardine_session_guid=(sardine_session_guid)
      if !sardine_session_guid.nil? && sardine_session_guid.to_s.length > 32
        fail ArgumentError, 'invalid value for "sardine_session_guid", the character length must be smaller than or equal to 32.'
      end

      if !sardine_session_guid.nil? && sardine_session_guid.to_s.length < 32
        fail ArgumentError, 'invalid value for "sardine_session_guid", the character length must be great than or equal to 32.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sardine_session_guid == o.sardine_session_guid
    end
    ...
    def hash
      [plan_guid, sardine_session_guid].hash
    end
