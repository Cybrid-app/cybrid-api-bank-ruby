...
module CybridApiBank
  class ExternalBankAccountBankModel
    ...
    def hash
      [guid, name, asset, account_kind, environment, bank_guid, customer_guid, created_at, updated_at, plaid_institution_id, plaid_account_mask, plaid_account_name, state, failure_code, balance_updated_at, balances, pii].hash
    end
