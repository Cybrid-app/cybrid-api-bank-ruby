...
module CybridApiBank
  class ExternalBankAccountBankModel
    ...
    attr_accessor :balance_updated_at
    ...
    def self.openapi_types
      {
        ...
        :'balances' => :'ExternalBankAccountBalancesBankModel',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'balance_updated_at')
        self.balance_updated_at = attributes[:'balance_updated_at']
      end
      ...
      if attributes.key?(:'pii')
        if (value = attributes[:'pii']).is_a?(Array)
          self.pii = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          balance_updated_at == o.balance_updated_at &&
          balances == o.balances &&
          pii == o.pii
    end
    ...
    def hash
      [guid, name, asset, account_kind, environment, bank_guid, customer_guid, counterparty_guid, created_at, updated_at, plaid_institution_id, plaid_account_mask, plaid_account_name, state, failure_code, balance_updated_at, balances, pii].hash
    end
