...
module CybridApiBank
  ...
  class PatchInternalExecutionBankModel
    # The executed amount for source account
    attr_accessor :source_executed_amount

    # The executed amount for destination account
    attr_accessor :destination_executed_amount

    # The state of the execution.
    attr_accessor :state

    # The timestamp when the plan started.
    attr_accessor :started_at

    # The timestamp when the plan completed.
    attr_accessor :completed_at

    # The timestamp when the plan failed.
    attr_accessor :failed_at

    # The failure code for the plan, if applicable.
    ...
    def self.attribute_map
      {
        :'source_executed_amount' => :'source_executed_amount',
        :'destination_executed_amount' => :'destination_executed_amount',
        :'state' => :'state',
    ...
    def self.openapi_types
      {
        :'source_executed_amount' => :'Integer',
        :'destination_executed_amount' => :'Integer',
        :'state' => :'String',
        :'started_at' => :'Time',
        :'completed_at' => :'Time',
        :'failed_at' => :'Time',
    ...
    def self.openapi_nullable
      Set.new([
        :'source_executed_amount',
        :'destination_executed_amount',
        :'started_at',
        :'completed_at',
        :'failed_at',
        :'failure_code'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::PatchInternalExecutionBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::PatchInternalExecutionBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'source_executed_amount')
        self.source_executed_amount = attributes[:'source_executed_amount']
      end

      if attributes.key?(:'destination_executed_amount')
        self.destination_executed_amount = attributes[:'destination_executed_amount']
      end
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ["storing", "executing", "completed", "failed"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["storing", "executing", "completed", "failed"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          source_executed_amount == o.source_executed_amount &&
          destination_executed_amount == o.destination_executed_amount &&
          state == o.state &&
    ...
    def hash
      [source_executed_amount, destination_executed_amount, state, started_at, completed_at, failed_at, failure_code].hash
    end
