...
module CybridApiBank
  # 
  class InternalFeeAssociationBankModel
    ...
    attr_accessor :quoted_amount

    # The executed amount in base units for the fee.
    attr_accessor :executed_amount

    # The unique identifier for the step the fee is associated with.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CybridApiBank::InternalFeeAssociationBankModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CybridApiBank::InternalFeeAssociationBankModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'quoted_amount')
        self.quoted_amount = attributes[:'quoted_amount']
      end

      if attributes.key?(:'executed_amount')
        self.executed_amount = attributes[:'executed_amount']
      end

      if attributes.key?(:'step_identifier')
        self.step_identifier = attributes[:'step_identifier']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @quoted_amount.nil?
        invalid_properties.push('invalid value for "quoted_amount", quoted_amount cannot be nil.')
      end

      if @step_identifier.nil?
        invalid_properties.push('invalid value for "step_identifier", step_identifier cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @quoted_amount.nil?
      return false if @step_identifier.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          step_identifier == o.step_identifier
    end
    ...
    def hash
      [type, asset, quoted_amount, executed_amount, step_identifier].hash
    end
