...
module CybridApiBank
  class TransactionsBankApi
    ...
    # @option opts [String] :bank_guid Comma separated bank_guids the account must belong to.
    # @option opts [String] :customer_guid Comma separated customer_guids the account must belong to.
    ...
    # @option opts [Boolean] :include_balances Include the running posted balance on the account as of each transaction.
    # @return [TransactionListBankModel]
    def list_transactions(account_guid, opts = {})
      data, _status_code, _headers = list_transactions_with_http_info(account_guid, opts)
      data
    end
    ...
    # @option opts [String] :created_at_lt Created at end date-time exclusive upper bound, ISO8601.
    # @option opts [Boolean] :include_balances Include the running posted balance on the account as of each transaction.
    # @return [Array<(TransactionListBankModel, Integer, Hash)>] TransactionListBankModel data, response status code and response headers
    def list_transactions_with_http_info(account_guid, opts = {})
