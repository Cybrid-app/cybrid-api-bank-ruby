...
The version of the OpenAPI document: v0.129.526
...
module CybridApiBank
  class PlansBankApi
    ...
    # @param post_plan_bank_model [PostPlanBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [PlanBankModel]
    def create_plan(post_plan_bank_model, opts = {})
      data, _status_code, _headers = create_plan_with_http_info(post_plan_bank_model, opts)
      data
    end
    ...
    # @param post_plan_bank_model [PostPlanBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PlanBankModel, Integer, Hash)>] PlanBankModel data, response status code and response headers
    def create_plan_with_http_info(post_plan_bank_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlansBankApi.create_plan ...'
      end
      # verify the required parameter 'post_plan_bank_model' is set
      if @api_client.config.client_side_validation && post_plan_bank_model.nil?
        fail ArgumentError, "Missing the required parameter 'post_plan_bank_model' when calling PlansBankApi.create_plan"
      end
      # resource path
      local_var_path = '/api/plans'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(post_plan_bank_model)

      # return_type
      return_type = opts[:debug_return_type] || 'PlanBankModel'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerAuth', 'oauth2']

      new_options = opts.merge(
        :operation => :"PlansBankApi.create_plan",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlansBankApi#create_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param plan_guid [String] Identifier for the payment instruction.
    # @param [Hash] opts the optional parameters
    # @return [PlanBankModel]
    def get_plan(plan_guid, opts = {})
      data, _status_code, _headers = get_plan_with_http_info(plan_guid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PlanBankModel, Integer, Hash)>] PlanBankModel data, response status code and response headers
    def get_plan_with_http_info(plan_guid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlansBankApi.get_plan ...'
      end
      # verify the required parameter 'plan_guid' is set
      if @api_client.config.client_side_validation && plan_guid.nil?
        fail ArgumentError, "Missing the required parameter 'plan_guid' when calling PlansBankApi.get_plan"
      end
      # resource path
      local_var_path = '/api/plans/{plan_guid}'.sub('{' + 'plan_guid' + '}', CGI.escape(plan_guid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PlansBankApi.get_plan",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlansBankApi#get_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :guid Comma separated plan_guids to list plans for.
    # @option opts [String] :bank_guid Comma separated bank_guids to list plans for.
    # @option opts [String] :customer_guid Comma separated customer_guids to list plans for.
    # @option opts [String] :type Comma separated types to list plans for.
    # @option opts [String] :state Comma separated states to list plans for.
    # @option opts [String] :source_account_guid Comma separated source account guids to list plans for.
    # @option opts [String] :destination_account_guid Comma separated destination account guids to list plans for.
    ...
    # @option opts [String] :updated_at_gte Updated at start date-time inclusive lower bound, ISO8601.
    # @option opts [String] :updated_at_lt Updated at end date-time exclusive upper bound, ISO8601.
    # @option opts [String] :label Comma separated labels to list plans for.
    # @return [PlanListBankModel]
    def list_plans(opts = {})
    ...
    # @option opts [String] :updated_at_lt Updated at end date-time exclusive upper bound, ISO8601.
    # @option opts [String] :label Comma separated labels to list plans for.
    # @return [Array<(PlanListBankModel, Integer, Hash)>] PlanListBankModel data, response status code and response headers
    def list_plans_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlansBankApi.list_plans ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page'].nil? && opts[:'page'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page"]" when calling PlansBankApi.list_plans, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling PlansBankApi.list_plans, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling PlansBankApi.list_plans, must be greater than or equal to 1.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PlanListBankModel'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerAuth', 'oauth2']

      new_options = opts.merge(
        :operation => :"PlansBankApi.list_plans",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlansBankApi#list_plans\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
