...
module CybridApiBank
  class FilesBankApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :include_download_url Include download information in response. Note, the files:pii:read scope is required if this parameter is set.
    # @return [PlatformFileBankModel]
    ...
    # @option opts [String] :guid Comma separated file_guids to list files for.
    # @option opts [String] :type Comma separated file types to list files for.
    # @option opts [String] :state Comma separated file states to list files for.
    # @option opts [String] :bank_guid Comma separated bank_guids to list files for.
    # @option opts [String] :customer_guid Comma separated customer_guids to list files for.
    ...
    # @option opts [String] :bank_guid Comma separated bank_guids to list files for.
    # @option opts [String] :customer_guid Comma separated customer_guids to list files for.
    # @return [Array<(PlatformFileListBankModel, Integer, Hash)>] PlatformFileListBankModel data, response status code and response headers
