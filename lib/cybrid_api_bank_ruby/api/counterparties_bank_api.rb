...
module CybridApiBank
  class CounterpartiesBankApi
    ...
    # @param post_counterparty_bank_model [PostCounterpartyBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [CounterpartyBankModel]
    def create_counterparty(post_counterparty_bank_model, opts = {})
      data, _status_code, _headers = create_counterparty_with_http_info(post_counterparty_bank_model, opts)
      data
    end
    ...
    def create_counterparty_with_http_info(post_counterparty_bank_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CounterpartiesBankApi.create_counterparty ...'
      end
      # verify the required parameter 'post_counterparty_bank_model' is set
      if @api_client.config.client_side_validation && post_counterparty_bank_model.nil?
        fail ArgumentError, "Missing the required parameter 'post_counterparty_bank_model' when calling CounterpartiesBankApi.create_counterparty"
      end
      # resource path
      local_var_path = '/api/counterparties'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(post_counterparty_bank_model)
      ...
      new_options = opts.merge(
        :operation => :"CounterpartiesBankApi.create_counterparty",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CounterpartiesBankApi#create_counterparty\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_counterparty(counterparty_guid, opts = {})
      data, _status_code, _headers = get_counterparty_with_http_info(counterparty_guid, opts)
      data
    end
    ...
    # @option opts [Boolean] :include_pii Include PII in the response.
    # @return [Array<(CounterpartyBankModel, Integer, Hash)>] CounterpartyBankModel data, response status code and response headers
    def get_counterparty_with_http_info(counterparty_guid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CounterpartiesBankApi.get_counterparty ...'
      end
      # verify the required parameter 'counterparty_guid' is set
      if @api_client.config.client_side_validation && counterparty_guid.nil?
        fail ArgumentError, "Missing the required parameter 'counterparty_guid' when calling CounterpartiesBankApi.get_counterparty"
      end
      # resource path
      local_var_path = '/api/counterparties/{counterparty_guid}'.sub('{' + 'counterparty_guid' + '}', CGI.escape(counterparty_guid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CounterpartiesBankApi.get_counterparty",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CounterpartiesBankApi#get_counterparty\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :type Comma separated types to list counterparties for.
    # @option opts [String] :bank_guid Comma separated bank_guids to list counterparties for.
    ...
    def list_counterparties_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CounterpartiesBankApi.list_counterparties ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page'].nil? && opts[:'page'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page"]" when calling CounterpartiesBankApi.list_counterparties, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling CounterpartiesBankApi.list_counterparties, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling CounterpartiesBankApi.list_counterparties, must be greater than or equal to 1.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CounterpartyListBankModel'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerAuth', 'oauth2']

      new_options = opts.merge(
        :operation => :"CounterpartiesBankApi.list_counterparties",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CounterpartiesBankApi#list_counterparties\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
