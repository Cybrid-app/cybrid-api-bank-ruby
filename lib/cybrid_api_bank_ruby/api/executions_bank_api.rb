...
module CybridApiBank
  class ExecutionsBankApi
    ...
    # @param post_execution_bank_model [PostExecutionBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [ExecutionBankModel]
    ...
    # @param post_execution_bank_model [PostExecutionBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ExecutionBankModel, Integer, Hash)>] ExecutionBankModel data, response status code and response headers
    ...
    # @param execution_guid [String] Identifier for the payment instruction.
    # @param [Hash] opts the optional parameters
    # @return [ExecutionBankModel]
    ...
    # @option opts [String] :guid Comma separated execution_guids to list executions for.
    # @option opts [String] :plan_guid Comma separated plan_guids to list executions for.
    # @option opts [String] :bank_guid Comma separated bank_guids to list executions for.
    # @option opts [String] :customer_guid Comma separated customer_guids to list executions for.
    # @option opts [String] :type Comma separated types to list executions for.
    # @option opts [String] :state Comma separated states to list executions for.
    # @option opts [String] :source_account_guid Comma separated source account guids to list executions for.
    # @option opts [String] :destination_account_guid Comma separated destination account guids to list executions for.
    ...
    # @option opts [String] :updated_at_gte Updated at start date-time inclusive lower bound, ISO8601.
    # @option opts [String] :updated_at_lt Updated at end date-time exclusive upper bound, ISO8601.
    # @return [Array<(ExecutionListBankModel, Integer, Hash)>] ExecutionListBankModel data, response status code and response headers
