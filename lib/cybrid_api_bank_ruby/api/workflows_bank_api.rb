...
module CybridApiBank
  class WorkflowsBankApi
    ...
    # @param post_workflow_bank_model [PostWorkflowBankModel] 
    ...
    # @param workflow_guid [String] Identifier for the workflow.
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkflowWithDetailsBankModel, Integer, Hash)>] WorkflowWithDetailsBankModel data, response status code and response headers
    ...
    # @option opts [String] :guid Comma separated workflow_guids to list workflows for.
    # @option opts [String] :bank_guid Comma separated bank_guids to list workflows for.
    # @option opts [String] :customer_guid Comma separated customer_guids to list workflows for.
    ...
    # @option opts [String] :bank_guid Comma separated bank_guids to list workflows for.
    # @option opts [String] :customer_guid Comma separated customer_guids to list workflows for.
    # @return [Array<(WorkflowsListBankModel, Integer, Hash)>] WorkflowsListBankModel data, response status code and response headers
