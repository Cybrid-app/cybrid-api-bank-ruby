...
module CybridApiBank
  class TransfersBankApi
    ...
    # @option opts [String] :updated_at_gte Created at start date inclusive lower bound, ISO8601
    # @option opts [String] :updated_at_lt Created at end date exclusive upper bound, ISO8601.
