...
module CybridApiBank
  class TransfersBankApi
    ...
    # @param accept_version [String] API version; must be 2026-04-01 or later for this operation.
    # @param [Hash] opts the optional parameters
    # @return [TransferBankModel]
    def cancel_transfer(transfer_guid, accept_version, opts = {})
      data, _status_code, _headers = cancel_transfer_with_http_info(transfer_guid, accept_version, opts)
      data
    end
    ...
    def cancel_transfer_with_http_info(transfer_guid, accept_version, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TransfersBankApi.cancel_transfer ...'
      end
      # verify the required parameter 'transfer_guid' is set
      if @api_client.config.client_side_validation && transfer_guid.nil?
        fail ArgumentError, "Missing the required parameter 'transfer_guid' when calling TransfersBankApi.cancel_transfer"
      end
      # verify the required parameter 'accept_version' is set
      if @api_client.config.client_side_validation && accept_version.nil?
        fail ArgumentError, "Missing the required parameter 'accept_version' when calling TransfersBankApi.cancel_transfer"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"TransfersBankApi.cancel_transfer",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransfersBankApi#cancel_transfer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param post_transfer_bank_model [PostTransferBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [TransferBankModel]
    ...
    # @option opts [String] :label Comma separated labels to list transfers for.
    # @option opts [String] :txn_hash Comma separated transaction hashes to list transfers for.
    ...
    # @option opts [String] :updated_at_gte Created at start date-time inclusive lower bound, ISO8601
    # @option opts [String] :updated_at_lt Created at end date-time exclusive upper bound, ISO8601.
    # @return [Array<(TransferListBankModel, Integer, Hash)>] TransferListBankModel data, response status code and response headers
    ...
    # @param transfer_guid [String] Identifier for the transfer.
    # @param patch_transfer_bank_model [PatchTransferBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [TransferBankModel]
    def update_transfer(transfer_guid, patch_transfer_bank_model, opts = {})
      data, _status_code, _headers = update_transfer_with_http_info(transfer_guid, patch_transfer_bank_model, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(TransferBankModel, Integer, Hash)>] TransferBankModel data, response status code and response headers
    def update_transfer_with_http_info(transfer_guid, patch_transfer_bank_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TransfersBankApi.update_transfer ...'
      end
      # verify the required parameter 'transfer_guid' is set
      if @api_client.config.client_side_validation && transfer_guid.nil?
        fail ArgumentError, "Missing the required parameter 'transfer_guid' when calling TransfersBankApi.update_transfer"
      end
      # verify the required parameter 'patch_transfer_bank_model' is set
      if @api_client.config.client_side_validation && patch_transfer_bank_model.nil?
        fail ArgumentError, "Missing the required parameter 'patch_transfer_bank_model' when calling TransfersBankApi.update_transfer"
      end
      # resource path
      local_var_path = '/api/transfers/{transfer_guid}'.sub('{' + 'transfer_guid' + '}', CGI.escape(transfer_guid.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patch_transfer_bank_model)
      ...
      new_options = opts.merge(
        :operation => :"TransfersBankApi.update_transfer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransfersBankApi#update_transfer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
