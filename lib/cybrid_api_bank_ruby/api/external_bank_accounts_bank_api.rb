...
module CybridApiBank
  class ExternalBankAccountsBankApi
    ...
    # @param post_external_bank_account_bank_model [PostExternalBankAccountBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [ExternalBankAccountBankModel]
    def create_external_bank_account(post_external_bank_account_bank_model, opts = {})
      data, _status_code, _headers = create_external_bank_account_with_http_info(post_external_bank_account_bank_model, opts)
      data
    end
    ...
    # @param post_external_bank_account_bank_model [PostExternalBankAccountBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ExternalBankAccountBankModel, Integer, Hash)>] ExternalBankAccountBankModel data, response status code and response headers
    def create_external_bank_account_with_http_info(post_external_bank_account_bank_model, opts = {})
      ...
      if @api_client.config.client_side_validation && post_external_bank_account_bank_model.nil?
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(post_external_bank_account_bank_model)
    ...
    def delete_external_bank_account(external_bank_account_guid, opts = {})
      data, _status_code, _headers = delete_external_bank_account_with_http_info(external_bank_account_guid, opts)
      data
    end
    ...
    def delete_external_bank_account_with_http_info(external_bank_account_guid, opts = {})
      ...
      # resource path
      local_var_path = '/api/external_bank_accounts/{external_bank_account_guid}'.sub('{' + 'external_bank_account_guid' + '}', CGI.escape(external_bank_account_guid.to_s))
    ...
    # @param external_bank_account_guid [String] Identifier for the external bank account.
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :force_balance_refresh Force the balance on the account to be retrieved.
    # @option opts [Boolean] :include_balances Include balance information in the response. If &#x60;force_balance_refresh&#x60; is &#x60;true&#x60;, the most up to date balance will be returned. If &#x60;force_balance_refresh&#x60; is &#x60;false&#x60;, the cached balance will be returned. &#x60;balance_updated_at&#x60; in the response will provide the timestamp the balance was last updated.
    # @option opts [Boolean] :include_pii Include the account holder&#39;s PII in the response (requires **external_bank_accounts:pii:read** scope).
    # @return [ExternalBankAccountBankModel]
    ...
    # @option opts [String] :counterparty_guid Comma separated counterparty_guids to list external_bank_accounts for.
    # @option opts [String] :asset Comma separated assets to list external_bank_accounts for.
    # @option opts [String] :state Comma separated states to list external_bank_accounts for. Filtering by \&quot;completed\&quot; and \&quot;unverified\&quot; states is only supported for individual customer accounts.
    ...
    # @option opts [String] :asset Comma separated assets to list external_bank_accounts for.
    # @option opts [String] :state Comma separated states to list external_bank_accounts for. Filtering by \&quot;completed\&quot; and \&quot;unverified\&quot; states is only supported for individual customer accounts.
    # @return [Array<(ExternalBankAccountListBankModel, Integer, Hash)>] ExternalBankAccountListBankModel data, response status code and response headers
    ...
    # @param external_bank_account_guid [String] Identifier for the external bank account.
    # @param patch_external_bank_account_bank_model [PatchExternalBankAccountBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [ExternalBankAccountBankModel]
    def patch_external_bank_account(external_bank_account_guid, patch_external_bank_account_bank_model, opts = {})
      data, _status_code, _headers = patch_external_bank_account_with_http_info(external_bank_account_guid, patch_external_bank_account_bank_model, opts)
      data
    end
    ...
    def patch_external_bank_account_with_http_info(external_bank_account_guid, patch_external_bank_account_bank_model, opts = {})
      ...
      if @api_client.config.client_side_validation && patch_external_bank_account_bank_model.nil?
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patch_external_bank_account_bank_model)
