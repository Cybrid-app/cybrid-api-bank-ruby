...
module CybridApiBank
  class AccountsBankApi
    ...
    # @param post_account_bank_model [PostAccountBankModel] 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :include_balances Whether to include account balances in the response.
    # @return [AccountBankModel]
    ...
    # @option opts [String] :label Comma separated labels to list accounts for.
    # @option opts [Boolean] :include_balances Whether to include account balances in the response.
    ...
    # @param account_guid [String] Identifier for the account.
    # @param patch_account_bank_model [PatchAccountBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [AccountBankModel]
    def update_account(account_guid, patch_account_bank_model, opts = {})
      data, _status_code, _headers = update_account_with_http_info(account_guid, patch_account_bank_model, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountBankModel, Integer, Hash)>] AccountBankModel data, response status code and response headers
    def update_account_with_http_info(account_guid, patch_account_bank_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountsBankApi.update_account ...'
      end
      # verify the required parameter 'account_guid' is set
      if @api_client.config.client_side_validation && account_guid.nil?
        fail ArgumentError, "Missing the required parameter 'account_guid' when calling AccountsBankApi.update_account"
      end
      # verify the required parameter 'patch_account_bank_model' is set
      if @api_client.config.client_side_validation && patch_account_bank_model.nil?
        fail ArgumentError, "Missing the required parameter 'patch_account_bank_model' when calling AccountsBankApi.update_account"
      end
      # resource path
      local_var_path = '/api/accounts/{account_guid}'.sub('{' + 'account_guid' + '}', CGI.escape(account_guid.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patch_account_bank_model)
      ...
      new_options = opts.merge(
        :operation => :"AccountsBankApi.update_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsBankApi#update_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
