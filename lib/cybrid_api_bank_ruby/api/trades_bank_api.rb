...
module CybridApiBank
  class TradesBankApi
    ...
    # @param post_trade_bank_model [PostTradeBankModel] 
    ...
    # @param post_trade_bank_model [PostTradeBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TradeBankModel, Integer, Hash)>] TradeBankModel data, response status code and response headers
    ...
    # @option opts [String] :account_guid Comma separated account_guids to list trades for.
    # @option opts [String] :state Comma separated states to list trades for.
    # @option opts [String] :side Comma separated sides to list trades for.
    # @option opts [String] :label Comma separated labels to list trades for.
    ...
    # @option opts [String] :updated_at_gte Updated at start date inclusive lower bound, ISO8601.
    # @option opts [String] :updated_at_lt Updated at end date exclusive upper bound, ISO8601.
