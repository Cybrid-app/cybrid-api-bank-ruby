...
module CybridApiBank
  class QuotesBankApi
    ...
    # @param post_quote_bank_model [PostQuoteBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [QuoteBankModel]
    def create_quote(post_quote_bank_model, opts = {})
      data, _status_code, _headers = create_quote_with_http_info(post_quote_bank_model, opts)
      data
    end
    ...
    # @param post_quote_bank_model [PostQuoteBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(QuoteBankModel, Integer, Hash)>] QuoteBankModel data, response status code and response headers
    def create_quote_with_http_info(post_quote_bank_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuotesBankApi.create_quote ...'
      end
      # verify the required parameter 'post_quote_bank_model' is set
      if @api_client.config.client_side_validation && post_quote_bank_model.nil?
        fail ArgumentError, "Missing the required parameter 'post_quote_bank_model' when calling QuotesBankApi.create_quote"
      end
      # resource path
      local_var_path = '/api/quotes'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(post_quote_bank_model)

      # return_type
      return_type = opts[:debug_return_type] || 'QuoteBankModel'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerAuth', 'oauth2']

      new_options = opts.merge(
        :operation => :"QuotesBankApi.create_quote",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuotesBankApi#create_quote\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(QuoteBankModel, Integer, Hash)>] QuoteBankModel data, response status code and response headers
    def get_quote_with_http_info(quote_guid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuotesBankApi.get_quote ...'
      end
      # verify the required parameter 'quote_guid' is set
      if @api_client.config.client_side_validation && quote_guid.nil?
        fail ArgumentError, "Missing the required parameter 'quote_guid' when calling QuotesBankApi.get_quote"
      end
      # resource path
      local_var_path = '/api/quotes/{quote_guid}'.sub('{' + 'quote_guid' + '}', CGI.escape(quote_guid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"QuotesBankApi.get_quote",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuotesBankApi#get_quote\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :product_type Comma separated product_types to list accounts for.
    ...
    # @option opts [String] :side Comma separated sides to list quotes for.
    ...
    # @option opts [String] :customer_guid Comma separated customer_guids to list quotes for.
    # @option opts [String] :side Comma separated sides to list quotes for.
    # @return [Array<(QuoteListBankModel, Integer, Hash)>] QuoteListBankModel data, response status code and response headers
    def list_quotes_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuotesBankApi.list_quotes ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page'].nil? && opts[:'page'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page"]" when calling QuotesBankApi.list_quotes, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling QuotesBankApi.list_quotes, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling QuotesBankApi.list_quotes, must be greater than or equal to 1.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'QuoteListBankModel'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerAuth', 'oauth2']

      new_options = opts.merge(
        :operation => :"QuotesBankApi.list_quotes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuotesBankApi#list_quotes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
