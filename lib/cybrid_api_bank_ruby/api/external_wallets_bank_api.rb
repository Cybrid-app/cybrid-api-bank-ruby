...
module CybridApiBank
  class ExternalWalletsBankApi
    ...
    # @param post_external_wallet_bank_model [PostExternalWalletBankModel] 
    ...
    # @param post_external_wallet_bank_model [PostExternalWalletBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ExternalWalletBankModel, Integer, Hash)>] ExternalWalletBankModel data, response status code and response headers
    ...
    # @param external_wallet_guid [String] Identifier for the external_wallet.
    # @param [Hash] opts the optional parameters
    # @return [ExternalWalletBankModel]
    ...
    # @option opts [String] :guid Comma separated external_wallet_guids to list external_wallets for.
    # @option opts [String] :bank_guid Comma separated bank_guids to list external_wallets for.
    # @option opts [String] :customer_guid Comma separated customer_guids to list external_wallets for.
    # @option opts [String] :counterparty_guid Comma separated counterparty_guids to list external_wallets for.
    # @option opts [String] :asset Comma separated assets to list external_wallets for.
    # @option opts [String] :state Comma separated states to list external_wallets for.
    ...
    # @option opts [String] :asset Comma separated assets to list external_wallets for.
    # @option opts [String] :state Comma separated states to list external_wallets for.
    # @return [Array<(ExternalWalletListBankModel, Integer, Hash)>] ExternalWalletListBankModel data, response status code and response headers
    ...
    # @param external_wallet_guid [String] Identifier for the external_wallet.
    # @param patch_external_wallet_bank_model [PatchExternalWalletBankModel] 
    # @param [Hash] opts the optional parameters
    # @return [ExternalWalletBankModel]
    def update_external_wallet(external_wallet_guid, patch_external_wallet_bank_model, opts = {})
      data, _status_code, _headers = update_external_wallet_with_http_info(external_wallet_guid, patch_external_wallet_bank_model, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ExternalWalletBankModel, Integer, Hash)>] ExternalWalletBankModel data, response status code and response headers
    def update_external_wallet_with_http_info(external_wallet_guid, patch_external_wallet_bank_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExternalWalletsBankApi.update_external_wallet ...'
      end
      # verify the required parameter 'external_wallet_guid' is set
      if @api_client.config.client_side_validation && external_wallet_guid.nil?
        fail ArgumentError, "Missing the required parameter 'external_wallet_guid' when calling ExternalWalletsBankApi.update_external_wallet"
      end
      # verify the required parameter 'patch_external_wallet_bank_model' is set
      if @api_client.config.client_side_validation && patch_external_wallet_bank_model.nil?
        fail ArgumentError, "Missing the required parameter 'patch_external_wallet_bank_model' when calling ExternalWalletsBankApi.update_external_wallet"
      end
      # resource path
      local_var_path = '/api/external_wallets/{external_wallet_guid}'.sub('{' + 'external_wallet_guid' + '}', CGI.escape(external_wallet_guid.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patch_external_wallet_bank_model)
      ...
      new_options = opts.merge(
        :operation => :"ExternalWalletsBankApi.update_external_wallet",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExternalWalletsBankApi#update_external_wallet\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
