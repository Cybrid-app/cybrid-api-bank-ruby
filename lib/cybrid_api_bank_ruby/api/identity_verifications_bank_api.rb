...
module CybridApiBank
  class IdentityVerificationsBankApi
    ...
    # @param post_identity_verification_bank_model [PostIdentityVerificationBankModel] 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :include_pii Include PII in the response (requires **identity_verifications:pii:read** scope).
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :include_pii Include PII in the response (requires **identity_verifications:pii:read** scope).
    # @return [Array<(IdentityVerificationWithDetailsBankModel, Integer, Hash)>] IdentityVerificationWithDetailsBankModel data, response status code and response headers
    ...
    # @option opts [String] :guid Comma separated guids to list identity verifications for.
    # @option opts [String] :bank_guid Comma separated bank_guids to list identity verifications for.
    # @option opts [String] :customer_guid Comma separated customer_guids to list identity verifications for.
    # @option opts [String] :counterparty_guid Comma separated counterparty_guids to list identity verifications for.
    # @option opts [String] :state Comma separated states to list identity verifications for.
    # @option opts [String] :type Comma separated types to list identity verifications for.
    # @option opts [String] :method Comma separated methods to list identity verifications for.
    ...
    # @option opts [String] :type Comma separated types to list identity verifications for.
    # @option opts [String] :method Comma separated methods to list identity verifications for.
    # @return [Array<(IdentityVerificationListBankModel, Integer, Hash)>] IdentityVerificationListBankModel data, response status code and response headers
    def list_identity_verifications_with_http_info(opts = {})
      ...
      query_params[:'counterparty_guid'] = opts[:'counterparty_guid'] if !opts[:'counterparty_guid'].nil?
