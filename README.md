...
```shell
gem install ./cybrid_api_bank_ruby-0.62.53.gem
```

(for development, run `gem install --dev ./cybrid_api_bank_ruby-0.62.53.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cybrid_api_bank_ruby', '~> 0.62.53'
