...
- API version: v0.129.1164
- Package version: 0.129.1164
...
```shell
gem install ./cybrid_api_bank_ruby-0.129.1164.gem
```

(for development, run `gem install --dev ./cybrid_api_bank_ruby-0.129.1164.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cybrid_api_bank_ruby', '~> 0.129.1164'
...
*CybridApiBank::AccountsBankApi* | [**update_account**](docs/AccountsBankApi.md#update_account) | **PATCH** /api/accounts/{account_guid} | Patch Account
...
*CybridApiBank::DepositAddressesBankApi* | [**update_deposit_address**](docs/DepositAddressesBankApi.md#update_deposit_address) | **PATCH** /api/deposit_addresses/{deposit_address_guid} | Patch Deposit Address
...
*CybridApiBank::DepositBankAccountsBankApi* | [**delete_deposit_bank_account**](docs/DepositBankAccountsBankApi.md#delete_deposit_bank_account) | **DELETE** /api/deposit_bank_accounts/{deposit_bank_account_guid} | Delete Deposit Bank Account
...
*CybridApiBank::DepositBankAccountsBankApi* | [**update_deposit_bank_account**](docs/DepositBankAccountsBankApi.md#update_deposit_bank_account) | **PATCH** /api/deposit_bank_accounts/{deposit_bank_account_guid} | Patch Deposit Bank Account
...
*CybridApiBank::ExecutionsBankApi* | [**list_executions**](docs/ExecutionsBankApi.md#list_executions) | **GET** /api/executions | Get executions list
...
*CybridApiBank::ExternalWalletsBankApi* | [**update_external_wallet**](docs/ExternalWalletsBankApi.md#update_external_wallet) | **PATCH** /api/external_wallets/{external_wallet_guid} | Patch External Wallet
...
*CybridApiBank::PlansBankApi* | [**list_plans**](docs/PlansBankApi.md#list_plans) | **GET** /api/plans | Get plans list
...
*CybridApiBank::SardineSessionsBankApi* | [**create_sardine_session**](docs/SardineSessionsBankApi.md#create_sardine_session) | **POST** /api/sardine_sessions | Create Sardine Session
...
*CybridApiBank::TransactionsBankApi* | [**list_transactions**](docs/TransactionsBankApi.md#list_transactions) | **GET** /api/transactions | List Transactions
*CybridApiBank::TransfersBankApi* | [**cancel_transfer**](docs/TransfersBankApi.md#cancel_transfer) | **DELETE** /api/transfers/{transfer_guid} | Cancel Transfer
...
## Documentation for Models
 ...
 - [CybridApiBank::BalanceBankModel](docs/BalanceBankModel.md)
 ...
 - [CybridApiBank::EffectiveRateBankModel](docs/EffectiveRateBankModel.md)
 ...
 - [CybridApiBank::ExecutionListBankModel](docs/ExecutionListBankModel.md)
 ...
 - [CybridApiBank::FeeDetailBankModel](docs/FeeDetailBankModel.md)
 - [CybridApiBank::HoldDetailBankModel](docs/HoldDetailBankModel.md)
 ...
 - [CybridApiBank::IdentityVerificationDocumentFileMetadataBankModel](docs/IdentityVerificationDocumentFileMetadataBankModel.md)
 ...
 - [CybridApiBank::IdentityVerificationWithDetailsPiiRegisteredAddressBankModel](docs/IdentityVerificationWithDetailsPiiRegisteredAddressBankModel.md)
 - [CybridApiBank::IntermediateAccountBankModel](docs/IntermediateAccountBankModel.md)
 - [CybridApiBank::InvoiceBankModel](docs/InvoiceBankModel.md)
 - [CybridApiBank::InvoiceListBankModel](docs/InvoiceListBankModel.md)
 - [CybridApiBank::LegalEntityNameBankModel](docs/LegalEntityNameBankModel.md)
 - [CybridApiBank::PatchAccountBankModel](docs/PatchAccountBankModel.md)
 ...
 - [CybridApiBank::PatchDepositAddressBankModel](docs/PatchDepositAddressBankModel.md)
 - [CybridApiBank::PatchDepositBankAccountBankModel](docs/PatchDepositBankAccountBankModel.md)
 - [CybridApiBank::PatchExternalBankAccountBankModel](docs/PatchExternalBankAccountBankModel.md)
 - [CybridApiBank::PatchExternalWalletBankModel](docs/PatchExternalWalletBankModel.md)
 ...
 - [CybridApiBank::PayoutReturnDetailsBankModel](docs/PayoutReturnDetailsBankModel.md)
 - [CybridApiBank::PersonaSessionBankModel](docs/PersonaSessionBankModel.md)
 - [CybridApiBank::PhysicalAddressBankModel](docs/PhysicalAddressBankModel.md)
 - [CybridApiBank::PlanBankModel](docs/PlanBankModel.md)
 - [CybridApiBank::PlanListBankModel](docs/PlanListBankModel.md)
 - [CybridApiBank::PlanReferenceBankModel](docs/PlanReferenceBankModel.md)
 - [CybridApiBank::PlanTravelRuleInfoBankModel](docs/PlanTravelRuleInfoBankModel.md)
 - [CybridApiBank::PlanTypeBankModel](docs/PlanTypeBankModel.md)
 ...
 - [CybridApiBank::PostFileMetadataBankModel](docs/PostFileMetadataBankModel.md)
 ...
 - [CybridApiBank::PostIdentityVerificationRegisteredAddressBankModel](docs/PostIdentityVerificationRegisteredAddressBankModel.md)
 ...
 - [CybridApiBank::PostPlanIntermediateAccountsInnerBankModel](docs/PostPlanIntermediateAccountsInnerBankModel.md)
 ...
 - [CybridApiBank::PostSardineSessionBankModel](docs/PostSardineSessionBankModel.md)
 - [CybridApiBank::PostSupportedPayoutSymbolsBankModel](docs/PostSupportedPayoutSymbolsBankModel.md)
 - [CybridApiBank::PostSupportingDocumentBankModel](docs/PostSupportingDocumentBankModel.md)
 ...
 - [CybridApiBank::ReturnDetailsBankModel](docs/ReturnDetailsBankModel.md)
 - [CybridApiBank::SardineSessionBankModel](docs/SardineSessionBankModel.md)
 - [CybridApiBank::StageBankModel](docs/StageBankModel.md)
 - [CybridApiBank::StageIdentifierBankModel](docs/StageIdentifierBankModel.md)
 - [CybridApiBank::StageLinkBankModel](docs/StageLinkBankModel.md)
 - [CybridApiBank::SupportingDocumentBankModel](docs/SupportingDocumentBankModel.md)
 - [CybridApiBank::SupportingDocumentFileBankModel](docs/SupportingDocumentFileBankModel.md)
 ...
 - [CybridApiBank::TransactionBankModel](docs/TransactionBankModel.md)
 - [CybridApiBank::TransactionListBankModel](docs/TransactionListBankModel.md)
 - [CybridApiBank::TransactionListPageInfoBankModel](docs/TransactionListPageInfoBankModel.md)
 - [CybridApiBank::TransactionResourceBankModel](docs/TransactionResourceBankModel.md)
 ...
 - [CybridApiBank::TransferIdentifiersInnerBankModel](docs/TransferIdentifiersInnerBankModel.md)
...
- **Scopes**: 
  ...
  - external_wallets:write: external_wallets write
  ...
  - sardine_sessions:execute: sardine_sessions execute
