...
# Unit tests for CybridApiBank::AssetsBankApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AssetsBankApi' do
  before do
  ...
  describe 'test an instance of AssetsBankApi' do
    it 'should create an instance of AssetsBankApi' do
      expect(@api_instance).to be_instance_of(CybridApiBank::AssetsBankApi)
    end
  end
