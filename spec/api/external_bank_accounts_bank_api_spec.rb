...
# Unit tests for CybridApiBank::ExternalBankAccountsBankApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExternalBankAccountsBankApi' do
  before do
  ...
  describe 'test an instance of ExternalBankAccountsBankApi' do
    it 'should create an instance of ExternalBankAccountsBankApi' do
      expect(@api_instance).to be_instance_of(CybridApiBank::ExternalBankAccountsBankApi)
    end
  end

  # unit tests for create_external_bank_account
  # Create ExternalBankAccount
  # Create an ExternalBankAccount.  Required scope: **external_bank_accounts:execute**
  # @param post_external_bank_account_bank_model 
  # @param [Hash] opts the optional parameters
  # @return [ExternalBankAccountBankModel]
  describe 'create_external_bank_account test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_external_bank_account
  ...
  # @param [Hash] opts the optional parameters
  # @return [ExternalBankAccountBankModel]
  describe 'delete_external_bank_account test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_external_bank_account
  # Get External Bank Account
  # Retrieves an external bank account.  Required scope: **external_bank_accounts:read**
  # @param external_bank_account_guid Identifier for the external bank account.
  # @param [Hash] opts the optional parameters
  # @return [ExternalBankAccountBankModel]
  describe 'get_external_bank_account test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_external_bank_accounts
  ...
  # @option opts [String] :guid Comma separated external_bank_account_guids to list external_bank_accounts for.
  # @option opts [String] :bank_guid Comma separated bank_guids to list external_bank_accounts for.
  # @option opts [String] :customer_guid Comma separated customer_guids to list external_bank_accounts for.
  # @option opts [String] :state Comma separated states to list external_bank_accounts for.
  # @return [ExternalBankAccountListBankModel]
  describe 'list_external_bank_accounts test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_external_bank_account
  # Patch ExternalBankAccount
  # Patch an external bank account.  Required scope: **external_bank_accounts:write**
  # @param external_bank_account_guid Identifier for the external bank account.
  # @param patch_external_bank_account_bank_model 
  # @param [Hash] opts the optional parameters
  # @return [ExternalBankAccountBankModel]
  describe 'patch_external_bank_account test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
