...
# Unit tests for CybridApiBank::BanksBankApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BanksBankApi' do
  before do
  ...
  describe 'test an instance of BanksBankApi' do
    it 'should create an instance of BanksBankApi' do
      expect(@api_instance).to be_instance_of(CybridApiBank::BanksBankApi)
    end
  end
