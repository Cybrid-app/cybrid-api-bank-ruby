...
# Unit tests for CybridApiBank::TradesBankApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TradesBankApi' do
  before do
  ...
  describe 'test an instance of TradesBankApi' do
    it 'should create an instance of TradesBankApi' do
      expect(@api_instance).to be_instance_of(CybridApiBank::TradesBankApi)
    end
  end

  # unit tests for create_trade
  # Create Trade
  ...
  # @param post_trade_bank_model 
  # @param [Hash] opts the optional parameters
  # @return [TradeBankModel]
  describe 'create_trade test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_trade
  # Get Trade
  # Retrieves a trade.  Required scope: **trades:read**
  # @param trade_guid Identifier for the trade.
  # @param [Hash] opts the optional parameters
  # @return [TradeBankModel]
  describe 'get_trade test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_trades
  # Get trades list
  # Retrieves a listing of trades.  Required scope: **trades:read**
  # @param customer_guid The customer&#39;s identifier.
  # @param account_guid The account&#39;s identifier.
  # @param [Hash] opts the optional parameters
