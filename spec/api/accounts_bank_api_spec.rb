...
# Unit tests for CybridApiBank::AccountsBankApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountsBankApi' do
  before do
  ...
  describe 'test an instance of AccountsBankApi' do
    it 'should create an instance of AccountsBankApi' do
      expect(@api_instance).to be_instance_of(CybridApiBank::AccountsBankApi)
    end
  end
