...
# Unit tests for CybridApiBank::CustomersBankApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomersBankApi' do
  before do
  ...
  describe 'test an instance of CustomersBankApi' do
    it 'should create an instance of CustomersBankApi' do
      expect(@api_instance).to be_instance_of(CybridApiBank::CustomersBankApi)
    end
  end
  ...
  # @param post_customer_bank_model 
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [String] :bank_guid Identifier for the bank.
  # @return [CustomerBankModel]
  ...
  # @option opts [String] :bank_guid Identifier for the bank.
  # @option opts [String] :guid Comma separated customer_guid to list customers for.
