...
# Unit tests for CybridApiBank::QuotesBankApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'QuotesBankApi' do
  before do
  ...
  describe 'test an instance of QuotesBankApi' do
    it 'should create an instance of QuotesBankApi' do
      expect(@api_instance).to be_instance_of(CybridApiBank::QuotesBankApi)
    end
  end
