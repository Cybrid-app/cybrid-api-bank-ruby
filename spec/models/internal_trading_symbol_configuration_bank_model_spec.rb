...
# Unit tests for CybridApiBank::InternalTradingSymbolConfigurationBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalTradingSymbolConfigurationBankModel do
  let(:instance) { CybridApiBank::InternalTradingSymbolConfigurationBankModel.new }

  describe 'test an instance of InternalTradingSymbolConfigurationBankModel' do
    it 'should create an instance of InternalTradingSymbolConfigurationBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalTradingSymbolConfigurationBankModel)
    end
  end
  ...
  describe 'test attribute "execution_mode"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["binding", "non_binding"])
      # validator.allowable_values.each do |value|
