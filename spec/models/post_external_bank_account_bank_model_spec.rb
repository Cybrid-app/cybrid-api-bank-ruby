...
# Unit tests for CybridApiBank::PostExternalBankAccountBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostExternalBankAccountBankModel do
  let(:instance) { CybridApiBank::PostExternalBankAccountBankModel.new }

  describe 'test an instance of PostExternalBankAccountBankModel' do
    it 'should create an instance of PostExternalBankAccountBankModel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CybridApiBank::PostExternalBankAccountBankModel)
    end
  end
  ...
  describe 'test attribute "plaid_public_token"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "expected_behaviours"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["passed_immediately", "failed_immediately"])
      # validator.allowable_values.each do |value|
      #   expect { instance.expected_behaviours = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "counterparty_bank_account_details"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "counterparty_address"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "counterparty_email_address"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
