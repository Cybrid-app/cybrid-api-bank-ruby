...
# Unit tests for CybridApiBank::InternalPayoutSymbolConfigurationBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalPayoutSymbolConfigurationBankModel do
  let(:instance) { CybridApiBank::InternalPayoutSymbolConfigurationBankModel.new }

  describe 'test an instance of InternalPayoutSymbolConfigurationBankModel' do
    it 'should create an instance of InternalPayoutSymbolConfigurationBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalPayoutSymbolConfigurationBankModel)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["platform", "bank"])
  ...
  describe 'test attribute "participants_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["C2C", "C2B", "B2C", "B2B"])
      # validator.allowable_values.each do |value|
      #   expect { instance.participants_type = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "route"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bank_account", "mobile_wallet"])
      # validator.allowable_values.each do |value|
