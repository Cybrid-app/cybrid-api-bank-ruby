...
# Unit tests for CybridApiBank::TransferBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::TransferBankModel do
  let(:instance) { CybridApiBank::TransferBankModel.new }

  describe 'test an instance of TransferBankModel' do
    it 'should create an instance of TransferBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::TransferBankModel)
    end
  end
  ...
  describe 'test attribute "transfer_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["funding", "book", "crypto", "instant_funding", "funding_return", "crypto_return"])
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "pending", "reviewing", "completed", "failed"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "transfer_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
