...
describe CybridApiBank::TransferBankModel do
  ...
  describe 'test attribute "transfer_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["savings", "funding", "book", "crypto", "internal_bank_rebalance", "internal_wallet_rebalance", "instant_funding"])
