...
The version of the OpenAPI document: v0.109.36
...
describe CybridApiBank::TransferBankModel do
  ...
  describe 'test attribute "transfer_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["funding", "book", "crypto", "instant_funding", "funding_return"])
