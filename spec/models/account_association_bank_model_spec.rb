...
# Unit tests for CybridApiBank::AccountAssociationBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::AccountAssociationBankModel do
  let(:instance) { CybridApiBank::AccountAssociationBankModel.new }

  describe 'test an instance of AccountAssociationBankModel' do
    it 'should create an instance of AccountAssociationBankModel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(CybridApiBank::AccountAssociationBankModel)
    end
  end
  ...
  describe 'test attribute "quoted_amount"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "executed_amount"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "intermediate_requested"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
