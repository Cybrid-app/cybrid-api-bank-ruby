...
# Unit tests for CybridApiBank::TradeBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::TradeBankModel do
  let(:instance) { CybridApiBank::TradeBankModel.new }

  describe 'test an instance of TradeBankModel' do
    it 'should create an instance of TradeBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::TradeBankModel)
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "pending", "cancelled", "executed", "completed", "settling", "failed"])
      # validator.allowable_values.each do |value|
