...
# Unit tests for CybridApiBank::PatchInternalIdentityVerificationBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PatchInternalIdentityVerificationBankModel do
  let(:instance) { CybridApiBank::PatchInternalIdentityVerificationBankModel.new }

  describe 'test an instance of PatchInternalIdentityVerificationBankModel' do
    it 'should create an instance of PatchInternalIdentityVerificationBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PatchInternalIdentityVerificationBankModel)
    end
  end
  ...
  describe 'test attribute "external_bank_account_check_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "attested_check_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "identity_workflow_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "pending_at"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "reviewing_at"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "failure_codes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["plaid_item_login_required", "plaid_invalid_product", "plaid_no_accounts", "plaid_item_not_found", "plaid_failure", "requested_failure", "deleted_account"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "supporting_file_guids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
