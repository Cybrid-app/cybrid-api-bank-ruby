...
# Unit tests for CybridApiBank::CustomerBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::CustomerBankModel do
  let(:instance) { CybridApiBank::CustomerBankModel.new }

  describe 'test an instance of CustomerBankModel' do
    it 'should create an instance of CustomerBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::CustomerBankModel)
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "unverified", "verified", "rejected", "frozen"])
      # validator.allowable_values.each do |value|
