...
# Unit tests for CybridApiBank::PostInternalTransferBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostInternalTransferBankModel do
  let(:instance) { CybridApiBank::PostInternalTransferBankModel.new }

  describe 'test an instance of PostInternalTransferBankModel' do
    it 'should create an instance of PostInternalTransferBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostInternalTransferBankModel)
    end
  end
  describe 'test attribute "transfer_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["book", "internal_bank_rebalance", "internal_wallet_rebalance", "funding_return", "crypto_return", "loss_recovery", "instant_funding_return"])
  ...
  describe 'test attribute "supports_reconciliation"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "requires_manual_confirmation"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
