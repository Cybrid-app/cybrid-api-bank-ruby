...
# Unit tests for CybridApiBank::InternalTransferScreeningBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalTransferScreeningBankModel do
  let(:instance) { CybridApiBank::InternalTransferScreeningBankModel.new }

  describe 'test an instance of InternalTransferScreeningBankModel' do
    it 'should create an instance of InternalTransferScreeningBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalTransferScreeningBankModel)
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "waiting", "reviewing", "completed"])
  ...
  describe 'test attribute "outcome"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["approved", "denied", "failed", "dismissed"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "failure_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["invalid_operation"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "hold_requested"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "administrative", "non_administrative"])
      # validator.allowable_values.each do |value|
      #   expect { instance.hold_requested = value }.not_to raise_error
      # end
    end
  end
