...
# Unit tests for CybridApiBank::AccountBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::AccountBankModel do
  let(:instance) { CybridApiBank::AccountBankModel.new }

  describe 'test an instance of AccountBankModel' do
    it 'should create an instance of AccountBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::AccountBankModel)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["backstopped", "trading", "fee", "savings", "staking"])
  ...
  describe 'test attribute "platform_balance"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "platform_available"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "created"])
      # validator.allowable_values.each do |value|
