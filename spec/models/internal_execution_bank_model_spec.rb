...
# Unit tests for CybridApiBank::InternalExecutionBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalExecutionBankModel do
  let(:instance) { CybridApiBank::InternalExecutionBankModel.new }

  describe 'test an instance of InternalExecutionBankModel' do
    it 'should create an instance of InternalExecutionBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalExecutionBankModel)
    end
  end
