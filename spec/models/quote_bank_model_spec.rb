...
# Unit tests for CybridApiBank::QuoteBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::QuoteBankModel do
  let(:instance) { CybridApiBank::QuoteBankModel.new }

  describe 'test an instance of QuoteBankModel' do
    it 'should create an instance of QuoteBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::QuoteBankModel)
    end
  end
  ...
  describe 'test attribute "product_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["trading", "funding", "book_transfer"])
