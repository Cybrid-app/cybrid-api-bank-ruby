...
# Unit tests for CybridApiBank::PlanBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PlanBankModel do
  let(:instance) { CybridApiBank::PlanBankModel.new }

  describe 'test an instance of PlanBankModel' do
    it 'should create an instance of PlanBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PlanBankModel)
    end
  end
  ...
  describe 'test attribute "supporting_documents"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
