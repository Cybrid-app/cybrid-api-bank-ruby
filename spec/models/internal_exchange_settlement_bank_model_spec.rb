...
# Unit tests for CybridApiBank::InternalExchangeSettlementBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalExchangeSettlementBankModel do
  let(:instance) { CybridApiBank::InternalExchangeSettlementBankModel.new }

  describe 'test an instance of InternalExchangeSettlementBankModel' do
    it 'should create an instance of InternalExchangeSettlementBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalExchangeSettlementBankModel)
    end
  end
  ...
  describe 'test attribute "trade_amounts"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "order_guids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "order_amounts"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "exchange_settlement_obligation_guids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "pending__created", "pending__approved", "failed_creation", "trades_completed"])
      # validator.allowable_values.each do |value|
