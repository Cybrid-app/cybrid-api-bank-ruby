...
# Unit tests for CybridApiBank::PlatformFileBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PlatformFileBankModel do
  let(:instance) { CybridApiBank::PlatformFileBankModel.new }

  describe 'test an instance of PlatformFileBankModel' do
    it 'should create an instance of PlatformFileBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PlatformFileBankModel)
    end
  end
