...
# Unit tests for CybridApiBank::CounterpartyBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::CounterpartyBankModel do
  let(:instance) { CybridApiBank::CounterpartyBankModel.new }

  describe 'test an instance of CounterpartyBankModel' do
    it 'should create an instance of CounterpartyBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::CounterpartyBankModel)
    end
  end
