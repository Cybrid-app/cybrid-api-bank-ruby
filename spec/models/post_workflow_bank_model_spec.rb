...
# Unit tests for CybridApiBank::PostWorkflowBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostWorkflowBankModel do
  let(:instance) { CybridApiBank::PostWorkflowBankModel.new }

  describe 'test an instance of PostWorkflowBankModel' do
    it 'should create an instance of PostWorkflowBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostWorkflowBankModel)
    end
  end
  ...
  describe 'test attribute "kind"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["link_token_create", "link_token_update"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "language"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["en", "fr", "es", "nl", "de"])
      # validator.allowable_values.each do |value|
