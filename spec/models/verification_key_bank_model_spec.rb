...
# Unit tests for CybridApiBank::VerificationKeyBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::VerificationKeyBankModel do
  let(:instance) { CybridApiBank::VerificationKeyBankModel.new }

  describe 'test an instance of VerificationKeyBankModel' do
    it 'should create an instance of VerificationKeyBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::VerificationKeyBankModel)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["attestation"])
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "pending", "verified", "failed"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "failure_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["invalid_algorithm", "invalid_nonce", "invalid_public_key", "invalid_signature"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "algorithm"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["RS512"])
      # validator.allowable_values.each do |value|
