...
# Unit tests for CybridApiBank::InternalInternalWalletBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalInternalWalletBankModel do
  let(:instance) { CybridApiBank::InternalInternalWalletBankModel.new }

  describe 'test an instance of InternalInternalWalletBankModel' do
    it 'should create an instance of InternalInternalWalletBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalInternalWalletBankModel)
    end
  end
