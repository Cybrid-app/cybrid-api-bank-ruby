...
# Unit tests for CybridApiBank::InternalQuoteBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalQuoteBankModel do
  let(:instance) { CybridApiBank::InternalQuoteBankModel.new }

  describe 'test an instance of InternalQuoteBankModel' do
    it 'should create an instance of InternalQuoteBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalQuoteBankModel)
    end
  end
  ...
  describe 'test attribute "product_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["trading", "trading_exit", "trading_liquidation", "funding", "book_transfer", "crypto_transfer", "internal_trading", "internal_bank_rebalance", "internal_wallet_rebalance", "loss_recovery_transfer", "inter_account", "lightning_transfer"])
  ...
  describe 'test attribute "transfer_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
