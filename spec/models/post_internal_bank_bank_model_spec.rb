...
# Unit tests for CybridApiBank::PostInternalBankBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostInternalBankBankModel do
  let(:instance) { CybridApiBank::PostInternalBankBankModel.new }

  describe 'test an instance of PostInternalBankBankModel' do
    it 'should create an instance of PostInternalBankBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostInternalBankBankModel)
    end
  end
  ...
  describe 'test attribute "features"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["attestation_identity_records", "attestation_identity_records_v2", "kyc_identity_verifications", "business_customers", "individual_customers", "raw_routing_details", "counterparty_external_accounts"])
      # validator.allowable_values.each do |value|
