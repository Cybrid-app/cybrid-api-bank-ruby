...
# Unit tests for CybridApiBank::IdentityVerificationBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::IdentityVerificationBankModel do
  let(:instance) { CybridApiBank::IdentityVerificationBankModel.new }

  describe 'test an instance of IdentityVerificationBankModel' do
    it 'should create an instance of IdentityVerificationBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::IdentityVerificationBankModel)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["kyc"])
  ...
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["id_and_selfie"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "waiting", "expired", "completed"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "outcome"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["passed", "failed"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "failure_codes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["requested_failure", "id_check_failure", "database_check_failure", "selfie_failure", "pep_check_failure", "watchlist_check_failure"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "persona_inquiry_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "persona_state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["waiting", "pending", "reviewing", "processing", "expired", "completed", "unknown"])
      # validator.allowable_values.each do |value|
      #   expect { instance.persona_state = value }.not_to raise_error
      # end
    end
  end
