...
describe CybridApiBank::IdentityVerificationBankModel do
  ...
  describe 'test attribute "failure_codes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["requested_failure"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "persona_state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["waiting", "pending", "reviewing", "expired", "completed", "unknown"])
      # validator.allowable_values.each do |value|
