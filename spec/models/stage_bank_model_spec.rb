...
# Unit tests for CybridApiBank::StageBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::StageBankModel do
  let(:instance) { CybridApiBank::StageBankModel.new }

  describe 'test an instance of StageBankModel' do
    it 'should create an instance of StageBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::StageBankModel)
    end
  end
  ...
  describe 'test attribute "deposit_return_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "withdrawal_return_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "payout_return_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
