...
# Unit tests for CybridApiBank::InternalStageBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalStageBankModel do
  let(:instance) { CybridApiBank::InternalStageBankModel.new }

  describe 'test an instance of InternalStageBankModel' do
    it 'should create an instance of InternalStageBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalStageBankModel)
    end
  end
  ...
  describe 'test attribute "stage_index"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
