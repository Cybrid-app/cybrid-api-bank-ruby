...
# Unit tests for CybridApiBank::InternalComplianceDecisionBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalComplianceDecisionBankModel do
  let(:instance) { CybridApiBank::InternalComplianceDecisionBankModel.new }

  describe 'test an instance of InternalComplianceDecisionBankModel' do
    it 'should create an instance of InternalComplianceDecisionBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalComplianceDecisionBankModel)
    end
  end
  ...
  describe 'test attribute "identity_verification_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["decided", "expired", "invalidated"])
      # validator.allowable_values.each do |value|
