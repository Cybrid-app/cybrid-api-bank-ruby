...
# Unit tests for CybridApiBank::ExchangeBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::ExchangeBankModel do
  let(:instance) { CybridApiBank::ExchangeBankModel.new }

  describe 'test an instance of ExchangeBankModel' do
    it 'should create an instance of ExchangeBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::ExchangeBankModel)
    end
  end
  ...
  describe 'test attribute "provider"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["aquanow", "dv_chain"])
