...
# Unit tests for CybridApiBank::PatchInternalExchangeOrderBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PatchInternalExchangeOrderBankModel do
  let(:instance) { CybridApiBank::PatchInternalExchangeOrderBankModel.new }

  describe 'test an instance of PatchInternalExchangeOrderBankModel' do
    it 'should create an instance of PatchInternalExchangeOrderBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PatchInternalExchangeOrderBankModel)
    end
  end
  describe 'test attribute "provider_order_guid"' do
    it 'should work' do
