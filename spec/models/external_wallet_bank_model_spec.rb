...
# Unit tests for CybridApiBank::ExternalWalletBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::ExternalWalletBankModel do
  let(:instance) { CybridApiBank::ExternalWalletBankModel.new }

  describe 'test an instance of ExternalWalletBankModel' do
    it 'should create an instance of ExternalWalletBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::ExternalWalletBankModel)
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "pending", "failed", "completed"])
      # validator.allowable_values.each do |value|
