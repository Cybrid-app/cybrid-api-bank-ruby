...
# Unit tests for CybridApiBank::IdentityVerificationWithDetailsBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::IdentityVerificationWithDetailsBankModel do
  let(:instance) { CybridApiBank::IdentityVerificationWithDetailsBankModel.new }

  describe 'test an instance of IdentityVerificationWithDetailsBankModel' do
    it 'should create an instance of IdentityVerificationWithDetailsBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::IdentityVerificationWithDetailsBankModel)
    end
  end
  ...
  describe 'test attribute "failure_codes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["requested_failure", "id_check_failure", "database_check_failure", "selfie_failure", "pep_check_failure", "watchlist_check_failure", "name_check_failure", "address_check_failure", "dob_check_failure", "id_number_check_failure", "phone_number_check_failure", "email_address_check_failure"])
      # validator.allowable_values.each do |value|
