...
# Unit tests for CybridApiBank::PatchInternalTransferBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PatchInternalTransferBankModel do
  let(:instance) { CybridApiBank::PatchInternalTransferBankModel.new }

  describe 'test an instance of PatchInternalTransferBankModel' do
    it 'should create an instance of PatchInternalTransferBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PatchInternalTransferBankModel)
    end
  end
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "holding", "reviewing", "completed", "failed"])
