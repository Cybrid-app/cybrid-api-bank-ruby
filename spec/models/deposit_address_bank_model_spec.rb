...
# Unit tests for CybridApiBank::DepositAddressBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::DepositAddressBankModel do
  let(:instance) { CybridApiBank::DepositAddressBankModel.new }

  describe 'test an instance of DepositAddressBankModel' do
    it 'should create an instance of DepositAddressBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::DepositAddressBankModel)
    end
  end
  ...
  describe 'test attribute "format"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["standard", "legacy"])
      # validator.allowable_values.each do |value|
