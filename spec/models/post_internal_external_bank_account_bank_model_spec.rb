...
# Unit tests for CybridApiBank::PostInternalExternalBankAccountBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostInternalExternalBankAccountBankModel do
  let(:instance) { CybridApiBank::PostInternalExternalBankAccountBankModel.new }

  describe 'test an instance of PostInternalExternalBankAccountBankModel' do
    it 'should create an instance of PostInternalExternalBankAccountBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostInternalExternalBankAccountBankModel)
    end
  end
  ...
  describe 'test attribute "beneficiary_memo"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
