...
# Unit tests for CybridApiBank::InternalPlanBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalPlanBankModel do
  let(:instance) { CybridApiBank::InternalPlanBankModel.new }

  describe 'test an instance of InternalPlanBankModel' do
    it 'should create an instance of InternalPlanBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalPlanBankModel)
    end
  end
