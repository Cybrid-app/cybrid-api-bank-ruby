...
# Unit tests for CybridApiBank::ExternalBankAccountBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::ExternalBankAccountBankModel do
  let(:instance) { CybridApiBank::ExternalBankAccountBankModel.new }

  describe 'test an instance of ExternalBankAccountBankModel' do
    it 'should create an instance of ExternalBankAccountBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::ExternalBankAccountBankModel)
    end
  end
  ...
  describe 'test attribute "account_kind"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["plaid", "plaid_processor_token", "raw_routing_details"])
  ...
  describe 'test attribute "plaid_institution_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "plaid_account_mask"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "plaid_account_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "completed", "failed", "refresh_required", "unverified", "deleting", "deleted"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "balance_updated_at"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
