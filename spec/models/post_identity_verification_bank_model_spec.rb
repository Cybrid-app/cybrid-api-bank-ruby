...
# Unit tests for CybridApiBank::PostIdentityVerificationBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostIdentityVerificationBankModel do
  let(:instance) { CybridApiBank::PostIdentityVerificationBankModel.new }

  describe 'test an instance of PostIdentityVerificationBankModel' do
    it 'should create an instance of PostIdentityVerificationBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostIdentityVerificationBankModel)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["kyc", "bank_account", "counterparty"])
  ...
  describe 'test attribute "expected_behaviours"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["passed_immediately", "failed_immediately", "tax_id_not_checked"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["watchlists", "attested", "document_submission", "enhanced_due_diligence", "id_and_selfie", "tax_id_and_selfie", "business_registration", "attested_id_and_selfie", "attested_business_registration", "attested_business_associate", "attested_id_and_database", "attested_database", "database", "attested_ownership", "account_ownership"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "require_tax_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "director_customer_guids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ultimate_beneficial_owners"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "business_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["entity", "sole_proprietor"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "business_incorporation_date"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "biometrics_verified"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
