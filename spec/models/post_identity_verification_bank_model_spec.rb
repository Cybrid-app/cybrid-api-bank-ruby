...
describe CybridApiBank::PostIdentityVerificationBankModel do
  ...
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["business_registration", "id_and_selfie", "tax_id_and_selfie", "attested", "plaid_identity_match", "document_submission"])
      # validator.allowable_values.each do |value|
