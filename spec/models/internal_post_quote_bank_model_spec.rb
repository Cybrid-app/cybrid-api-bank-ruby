...
# Unit tests for CybridApiBank::InternalPostQuoteBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalPostQuoteBankModel do
  let(:instance) { CybridApiBank::InternalPostQuoteBankModel.new }

  describe 'test an instance of InternalPostQuoteBankModel' do
    it 'should create an instance of InternalPostQuoteBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalPostQuoteBankModel)
    end
  end
  describe 'test attribute "product_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["book_transfer", "trading_liquidation", "internal_trading", "internal_bank_rebalance", "internal_wallet_rebalance", "loss_recovery_transfer"])
