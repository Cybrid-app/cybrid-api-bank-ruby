...
# Unit tests for CybridApiBank::DepositBankAccountBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::DepositBankAccountBankModel do
  let(:instance) { CybridApiBank::DepositBankAccountBankModel.new }

  describe 'test an instance of DepositBankAccountBankModel' do
    it 'should create an instance of DepositBankAccountBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::DepositBankAccountBankModel)
    end
  end
  ...
  describe 'test attribute "unique_memo_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "parent_deposit_bank_account_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
