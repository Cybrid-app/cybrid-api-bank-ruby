...
describe CybridApiBank::BankBankModel do
  ...
  describe 'test attribute "features"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["attestation_identity_records", "kyc_identity_verifications", "backstopped_funding_source", "plaid_funding_source"])
      # validator.allowable_values.each do |value|
