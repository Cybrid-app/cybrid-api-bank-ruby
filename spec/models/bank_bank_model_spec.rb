...
# Unit tests for CybridApiBank::BankBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::BankBankModel do
  let(:instance) { CybridApiBank::BankBankModel.new }

  describe 'test an instance of BankBankModel' do
    it 'should create an instance of BankBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::BankBankModel)
    end
  end
  ...
  describe 'test attribute "supported_trading_symbols"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "supported_fiat_account_assets"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "supported_country_codes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "features"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["attestation_identity_records", "kyc_identity_verifications", "raw_routing_details", "individual_customers", "business_customers"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "routable_accounts"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unsupported", "bank", "customer"])
      # validator.allowable_values.each do |value|
      #   expect { instance.routable_accounts = value }.not_to raise_error
      # end
    end
  end
