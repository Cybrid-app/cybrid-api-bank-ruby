...
# Unit tests for CybridApiBank::PostQuoteBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostQuoteBankModel do
  let(:instance) { CybridApiBank::PostQuoteBankModel.new }

  describe 'test an instance of PostQuoteBankModel' do
    it 'should create an instance of PostQuoteBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostQuoteBankModel)
    end
  end
  describe 'test attribute "product_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["trading", "funding", "crypto_transfer", "inter_account", "lightning_transfer", "book_transfer"])
  ...
  describe 'test attribute "side"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["deposit", "withdrawal", "buy", "sell"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "destination_account_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "payment_rail"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ach", "eft", "wire", "rtp", "etransfer"])
      # validator.allowable_values.each do |value|
      #   expect { instance.payment_rail = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "destination_accounts"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "reference_trade_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "source_account_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
