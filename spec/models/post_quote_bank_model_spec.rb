...
describe CybridApiBank::PostQuoteBankModel do
  ...
  describe 'test attribute "product_type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["trading", "trading_exit", "funding", "crypto_transfer", "inter_account", "lightning_transfer", "book_transfer"])
