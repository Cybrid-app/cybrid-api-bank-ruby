...
describe CybridApiBank::PostQuoteBankModel do
  ...
  describe 'test attribute "product_type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["trading", "savings"])
  ...
  describe 'test attribute "side"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["buy", "sell", "deposit", "withdrawal"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "product_provider"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["compound"])
      # validator.allowable_values.each do |value|
      #   expect { instance.product_provider = value }.not_to raise_error
      # end
    end
  end
