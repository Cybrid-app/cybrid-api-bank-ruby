...
describe CybridApiBank::PostQuoteBankModel do
  ...
  describe 'test attribute "product_type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["trading", "trading_exit", "funding", "book_transfer", "crypto_transfer", "inter_account", "lightning_transfer"])
