...
# Unit tests for CybridApiBank::InternalBankBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalBankBankModel do
  let(:instance) { CybridApiBank::InternalBankBankModel.new }

  describe 'test an instance of InternalBankBankModel' do
    it 'should create an instance of InternalBankBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalBankBankModel)
    end
  end
  ...
  describe 'test attribute "supported_payout_symbols"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "persona_theme_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "return_code_thresholds"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
