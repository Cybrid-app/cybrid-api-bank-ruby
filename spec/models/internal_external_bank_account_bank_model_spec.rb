...
# Unit tests for CybridApiBank::InternalExternalBankAccountBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalExternalBankAccountBankModel do
  let(:instance) { CybridApiBank::InternalExternalBankAccountBankModel.new }

  describe 'test an instance of InternalExternalBankAccountBankModel' do
    it 'should create an instance of InternalExternalBankAccountBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalExternalBankAccountBankModel)
    end
  end
  ...
  describe 'test attribute "account_kind"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["modern_treasury_external_account", "plaid", "plaid_processor_token", "raw_routing_details"])
