...
# Unit tests for CybridApiBank::PostInternalActivityLimitConfigurationBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostInternalActivityLimitConfigurationBankModel do
  let(:instance) { CybridApiBank::PostInternalActivityLimitConfigurationBankModel.new }

  describe 'test an instance of PostInternalActivityLimitConfigurationBankModel' do
    it 'should create an instance of PostInternalActivityLimitConfigurationBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostInternalActivityLimitConfigurationBankModel)
    end
  end
  ...
  describe 'test attribute "audience"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["individual_tax_id_unverified_customer", "individual_tax_id_verified_customer", "business_customer"])
      # validator.allowable_values.each do |value|
