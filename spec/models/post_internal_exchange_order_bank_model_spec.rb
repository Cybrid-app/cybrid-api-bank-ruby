...
# Unit tests for CybridApiBank::PostInternalExchangeOrderBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostInternalExchangeOrderBankModel do
  let(:instance) { CybridApiBank::PostInternalExchangeOrderBankModel.new }

  describe 'test an instance of PostInternalExchangeOrderBankModel' do
    it 'should create an instance of PostInternalExchangeOrderBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostInternalExchangeOrderBankModel)
    end
  end
  ...
  describe 'test attribute "fixed_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["deliver", "receive"])
      # validator.allowable_values.each do |value|
      #   expect { instance.fixed_amount = value }.not_to raise_error
      # end
    end
  end
