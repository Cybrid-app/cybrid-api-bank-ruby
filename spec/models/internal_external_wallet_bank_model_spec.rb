...
# Unit tests for CybridApiBank::InternalExternalWalletBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalExternalWalletBankModel do
  let(:instance) { CybridApiBank::InternalExternalWalletBankModel.new }

  describe 'test an instance of InternalExternalWalletBankModel' do
    it 'should create an instance of InternalExternalWalletBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalExternalWalletBankModel)
    end
  end
  ...
  describe 'test attribute "account_kind"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fireblocks_external_wallet", "circle_wire_external_wallet"])
  ...
  describe 'test attribute "exchange_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["storing", "pending", "failed", "completed", "deleting", "deleted"])
      # validator.allowable_values.each do |value|
