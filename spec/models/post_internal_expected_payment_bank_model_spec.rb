...
# Unit tests for CybridApiBank::PostInternalExpectedPaymentBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostInternalExpectedPaymentBankModel do
  let(:instance) { CybridApiBank::PostInternalExpectedPaymentBankModel.new }

  describe 'test an instance of PostInternalExpectedPaymentBankModel' do
    it 'should create an instance of PostInternalExpectedPaymentBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostInternalExpectedPaymentBankModel)
    end
  end
