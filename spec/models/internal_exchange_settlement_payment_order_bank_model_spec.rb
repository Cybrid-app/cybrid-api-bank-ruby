...
# Unit tests for CybridApiBank::InternalExchangeSettlementPaymentOrderBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalExchangeSettlementPaymentOrderBankModel do
  let(:instance) { CybridApiBank::InternalExchangeSettlementPaymentOrderBankModel.new }

  describe 'test an instance of InternalExchangeSettlementPaymentOrderBankModel' do
    it 'should create an instance of InternalExchangeSettlementPaymentOrderBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalExchangeSettlementPaymentOrderBankModel)
    end
  end
