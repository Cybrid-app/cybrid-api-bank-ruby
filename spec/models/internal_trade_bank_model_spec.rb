...
# Unit tests for CybridApiBank::InternalTradeBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalTradeBankModel do
  let(:instance) { CybridApiBank::InternalTradeBankModel.new }

  describe 'test an instance of InternalTradeBankModel' do
    it 'should create an instance of InternalTradeBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalTradeBankModel)
    end
  end
  ...
  describe 'test attribute "trade_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["platform", "internal", "liquidation", "exit"])
