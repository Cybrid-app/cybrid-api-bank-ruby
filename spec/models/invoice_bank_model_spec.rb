...
# Unit tests for CybridApiBank::InvoiceBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InvoiceBankModel do
  let(:instance) { CybridApiBank::InvoiceBankModel.new }

  describe 'test an instance of InvoiceBankModel' do
    it 'should create an instance of InvoiceBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InvoiceBankModel)
    end
  end
