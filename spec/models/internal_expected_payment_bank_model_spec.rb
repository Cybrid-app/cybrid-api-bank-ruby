...
# Unit tests for CybridApiBank::InternalExpectedPaymentBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalExpectedPaymentBankModel do
  let(:instance) { CybridApiBank::InternalExpectedPaymentBankModel.new }

  describe 'test an instance of InternalExpectedPaymentBankModel' do
    it 'should create an instance of InternalExpectedPaymentBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalExpectedPaymentBankModel)
    end
  end
  ...
  describe 'test attribute "payment_kind"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["gas_payment", "gas_settlement", "platform_payment", "exchange_settlement"])
      # validator.allowable_values.each do |value|
      #   expect { instance.payment_kind = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "settlement_account_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
