...
# Unit tests for CybridApiBank::PostInternalExchangeSettlementPaymentOrderBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostInternalExchangeSettlementPaymentOrderBankModel do
  let(:instance) { CybridApiBank::PostInternalExchangeSettlementPaymentOrderBankModel.new }

  describe 'test an instance of PostInternalExchangeSettlementPaymentOrderBankModel' do
    it 'should create an instance of PostInternalExchangeSettlementPaymentOrderBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostInternalExchangeSettlementPaymentOrderBankModel)
    end
  end
  describe 'test attribute "exchange_settlement_guid"' do
    it 'should work' do
  ...
  describe 'test attribute "expected_state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "in_progress", "completed", "failed", "cancelled", "manual_intervention"])
      # validator.allowable_values.each do |value|
      #   expect { instance.expected_state = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "network_fee_account_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "internal_network_fee_wallet_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
