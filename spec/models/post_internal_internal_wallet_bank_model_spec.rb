...
# Unit tests for CybridApiBank::PostInternalInternalWalletBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::PostInternalInternalWalletBankModel do
  let(:instance) { CybridApiBank::PostInternalInternalWalletBankModel.new }

  describe 'test an instance of PostInternalInternalWalletBankModel' do
    it 'should create an instance of PostInternalInternalWalletBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::PostInternalInternalWalletBankModel)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["internal_omnibus", "internal_trading_deposits"])
  ...
  describe 'test attribute "account_kind"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fireblocks_vault", "circle_master_wallet", "strike_account", "bitgo_enterprise_wallet", "falconx_account", "aquanow_account", "bitso_account"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "wallet_service_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "internal_wallet_group_guid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "routing_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
