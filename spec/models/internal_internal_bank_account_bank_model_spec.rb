...
# Unit tests for CybridApiBank::InternalInternalBankAccountBankModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CybridApiBank::InternalInternalBankAccountBankModel do
  let(:instance) { CybridApiBank::InternalInternalBankAccountBankModel.new }

  describe 'test an instance of InternalInternalBankAccountBankModel' do
    it 'should create an instance of InternalInternalBankAccountBankModel' do
      expect(instance).to be_instance_of(CybridApiBank::InternalInternalBankAccountBankModel)
    end
  end
  ...
  describe 'test attribute "account_kind"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["circle_master_wallet", "modern_treasury_internal_account", "strike_account", "falconx_account", "aquanow_account", "bitso_account"])
